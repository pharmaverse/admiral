...
- order:
  ...
  section in
  [`vignette("generic")`](https:/pharmaverse.github.io/admiral/3171-general-issue-update-imports/articles/generic.md).
...
### Considering order of values ([`min_cond()`](https:/pharmaverse.github.io/admiral/3171-general-issue-update-imports/reference/min_cond.md), [`max_cond()`](https:/pharmaverse.github.io/admiral/3171-general-issue-update-imports/reference/max_cond.md))
