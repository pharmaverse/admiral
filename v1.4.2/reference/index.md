...
- [`derive_vars_computed()`](https:/pharmaverse.github.io/admiral/v1.4.2/reference/derive_vars_computed.md)
  : Adds Variable(s) Computed from the Analysis Value of one or more
  Parameters

- [`derive_vars_dt()`](https:/pharmaverse.github.io/admiral/v1.4.2/reference/derive_vars_dt.md)
...
- [`derive_var_age_years()`](https:/pharmaverse.github.io/admiral/v1.4.2/reference/derive_var_age_years.md)
  : Derive Age in Years
- [`derive_vars_aage()`](https:/pharmaverse.github.io/admiral/v1.4.2/reference/derive_vars_aage.md)
  : Derive Analysis Age
...
- [`derive_vars_period()`](https:/pharmaverse.github.io/admiral/v1.4.2/reference/derive_vars_period.md)
...
- [`derive_basetype_records()`](https:/pharmaverse.github.io/admiral/v1.4.2/reference/derive_basetype_records.md)
  : Derive Basetype Variable

- [`derive_var_analysis_ratio()`](https:/pharmaverse.github.io/admiral/v1.4.2/reference/derive_var_analysis_ratio.md)
  : Derive Ratio Variable

- [`derive_var_anrind()`](https:/pharmaverse.github.io/admiral/v1.4.2/reference/derive_var_anrind.md)
  : Derive Reference Range Indicator

- [`derive_var_atoxgr()`](https:/pharmaverse.github.io/admiral/v1.4.2/reference/derive_var_atoxgr.md)
...
- [`derive_var_base()`](https:/pharmaverse.github.io/admiral/v1.4.2/reference/derive_var_base.md)
  : Derive Baseline Variables

- [`derive_var_chg()`](https:/pharmaverse.github.io/admiral/v1.4.2/reference/derive_var_chg.md)
  : Derive Change from Baseline

- [`derive_var_nfrlt()`](https:/pharmaverse.github.io/admiral/v1.4.2/reference/derive_var_nfrlt.md)
...
- [`derive_var_pchg()`](https:/pharmaverse.github.io/admiral/v1.4.2/reference/derive_var_pchg.md)
  : Derive Percent Change from Baseline

- [`derive_var_shift()`](https:/pharmaverse.github.io/admiral/v1.4.2/reference/derive_var_shift.md)
  : Derive Shift

- [`derive_vars_crit_flag()`](https:/pharmaverse.github.io/admiral/v1.4.2/reference/derive_vars_crit_flag.md)
  :
...
- [`atoxgr_criteria_ctcv4`](https:/pharmaverse.github.io/admiral/v1.4.2/reference/atoxgr_criteria_ctcv4.md)
  ...
  where applicable
- [`atoxgr_criteria_ctcv4_uscv`](https:/pharmaverse.github.io/admiral/v1.4.2/reference/atoxgr_criteria_ctcv4_uscv.md)
...
- [`ex_single`](https:/pharmaverse.github.io/admiral/v1.4.2/reference/ex_single.md)
...
- [`get_admiral_option()`](https:/pharmaverse.github.io/admiral/v1.4.2/reference/get_admiral_option.md)
  : Get the Value of an Admiral Option
- [`set_admiral_options()`](https:/pharmaverse.github.io/admiral/v1.4.2/reference/set_admiral_options.md)
...
- [`derivation_slice()`](https:/pharmaverse.github.io/admiral/v1.4.2/reference/derivation_slice.md)
  :

  Create a `derivation_slice` Object

- [`restrict_derivation()`](https:/pharmaverse.github.io/admiral/v1.4.2/reference/restrict_derivation.md)
  : Execute a Derivation on a Subset of the Input Dataset

- [`slice_derivation()`](https:/pharmaverse.github.io/admiral/v1.4.2/reference/slice_derivation.md)
  : Execute a Derivation with Different Arguments for Subsets of the
  Input Dataset

### Creating Auxiliary Datasets

- [`consolidate_metadata()`](https:/pharmaverse.github.io/admiral/v1.4.2/reference/consolidate_metadata.md)
  : Consolidate Multiple Meta Datasets Into a Single One

- [`create_period_dataset()`](https:/pharmaverse.github.io/admiral/v1.4.2/reference/create_period_dataset.md)
...
- [`create_single_dose_dataset()`](https:/pharmaverse.github.io/admiral/v1.4.2/reference/create_single_dose_dataset.md)
...
- [`death_event`](https:/pharmaverse.github.io/admiral/v1.4.2/reference/tte_source_objects.md)
  [`lastalive_censor`](https:/pharmaverse.github.io/admiral/v1.4.2/reference/tte_source_objects.md)
  [`ae_event`](https:/pharmaverse.github.io/admiral/v1.4.2/reference/tte_source_objects.md)
  [`ae_ser_event`](https:/pharmaverse.github.io/admiral/v1.4.2/reference/tte_source_objects.md)
  [`ae_gr1_event`](https:/pharmaverse.github.io/admiral/v1.4.2/reference/tte_source_objects.md)
  [`ae_gr2_event`](https:/pharmaverse.github.io/admiral/v1.4.2/reference/tte_source_objects.md)
  [`ae_gr3_event`](https:/pharmaverse.github.io/admiral/v1.4.2/reference/tte_source_objects.md)
  [`ae_gr4_event`](https:/pharmaverse.github.io/admiral/v1.4.2/reference/tte_source_objects.md)
  [`ae_gr5_event`](https:/pharmaverse.github.io/admiral/v1.4.2/reference/tte_source_objects.md)
  [`ae_gr35_event`](https:/pharmaverse.github.io/admiral/v1.4.2/reference/tte_source_objects.md)
  [`ae_sev_event`](https:/pharmaverse.github.io/admiral/v1.4.2/reference/tte_source_objects.md)
  [`ae_wd_event`](https:/pharmaverse.github.io/admiral/v1.4.2/reference/tte_source_objects.md)
  : Pre-Defined Time-to-Event Source Objects

### Other

- [`list_tte_source_objects()`](https:/pharmaverse.github.io/admiral/v1.4.2/reference/list_tte_source_objects.md)
  :

  List all `tte_source` Objects Available in a Package

- [`params()`](https:/pharmaverse.github.io/admiral/v1.4.2/reference/params.md)
...
- [`convert_na_to_blanks()`](https:/pharmaverse.github.io/admiral/v1.4.2/reference/convert_na_to_blanks.md)
...
- [`get_many_to_one_dataset()`](https:/pharmaverse.github.io/admiral/v1.4.2/reference/get_many_to_one_dataset.md)
...
- [`extract_unit()`](https:/pharmaverse.github.io/admiral/v1.4.2/reference/extract_unit.md)
  : Extract Unit From Parameter Description
- [`get_flagged_records()`](https:/pharmaverse.github.io/admiral/v1.4.2/reference/get_flagged_records.md)
  : Create an Existence Flag
- [`get_not_mapped()`](https:/pharmaverse.github.io/admiral/v1.4.2/reference/get_not_mapped.md)
  : Get list of records not mapped from the lookup table.
- [`get_vars_query()`](https:/pharmaverse.github.io/admiral/v1.4.2/reference/get_vars_query.md)
  : Get Query Variables

### Utilities for Filtering Observations

- [`count_vals()`](https:/pharmaverse.github.io/admiral/v1.4.2/reference/count_vals.md)
  : Count Number of Observations Where a Variable Equals a Value
- [`filter_exist()`](https:/pharmaverse.github.io/admiral/v1.4.2/reference/filter_exist.md)
  : Returns records that fit into existing by groups in a filtered
  source dataset
- [`filter_extreme()`](https:/pharmaverse.github.io/admiral/v1.4.2/reference/filter_extreme.md)
...
- [`filter_not_exist()`](https:/pharmaverse.github.io/admiral/v1.4.2/reference/filter_not_exist.md)
  : Returns records that don't fit into existing by groups in a filtered
  source dataset
- [`filter_relative()`](https:/pharmaverse.github.io/admiral/v1.4.2/reference/filter_relative.md)
  : Filter the Observations Before or After a Condition is Fulfilled
- [`max_cond()`](https:/pharmaverse.github.io/admiral/v1.4.2/reference/max_cond.md)
  : Maximum Value on a Subset
- [`min_cond()`](https:/pharmaverse.github.io/admiral/v1.4.2/reference/min_cond.md)
  : Minimum Value on a Subset

### Utilities for Quosures

- [`chr2vars()`](https:/pharmaverse.github.io/admiral/v1.4.2/reference/chr2vars.md)
  : Turn a Character Vector into a List of Expressions
- [`negate_vars()`](https:/pharmaverse.github.io/admiral/v1.4.2/reference/negate_vars.md)
...
- [`` `%>%` ``](https:/pharmaverse.github.io/admiral/v1.4.2/reference/pipe.md)
  : Pipe operator
- [`desc`](https:/pharmaverse.github.io/admiral/v1.4.2/reference/reexport-desc.md)
  : dplyr desc
...
- [`call_user_fun()`](https:/pharmaverse.github.io/admiral/v1.4.2/reference/call_user_fun.md)
  **\[deprecated\]** : Calls a Function Provided by the User

- [`date_source()`](https:/pharmaverse.github.io/admiral/v1.4.2/reference/date_source.md)
  **\[deprecated\]** :

  Create a `date_source` object

- [`derive_param_extreme_record()`](https:/pharmaverse.github.io/admiral/v1.4.2/reference/derive_param_extreme_record.md)
  **\[deprecated\]** : Adds a Parameter Based on First or Last Record
  from Multiple Sources

- [`derive_var_dthcaus()`](https:/pharmaverse.github.io/admiral/v1.4.2/reference/derive_var_dthcaus.md)
  **\[deprecated\]** : Derive Death Cause

- [`derive_var_extreme_dt()`](https:/pharmaverse.github.io/admiral/v1.4.2/reference/derive_var_extreme_dt.md)
  **\[deprecated\]** : Derive First or Last Date from Multiple Sources

- [`derive_var_extreme_dtm()`](https:/pharmaverse.github.io/admiral/v1.4.2/reference/derive_var_extreme_dtm.md)
  **\[deprecated\]** : Derive First or Last Datetime from Multiple
  Sources

- [`derive_var_merged_summary()`](https:/pharmaverse.github.io/admiral/v1.4.2/reference/derive_var_merged_summary.md)
  **\[deprecated\]** : Merge Summary Variables

- [`dthcaus_source()`](https:/pharmaverse.github.io/admiral/v1.4.2/reference/dthcaus_source.md)
  **\[deprecated\]** :

  Create a `dthcaus_source` Object

- [`get_summary_records()`](https:/pharmaverse.github.io/admiral/v1.4.2/reference/get_summary_records.md)
