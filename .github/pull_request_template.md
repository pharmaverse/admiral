...
- [ ] Review the [Cheat Sheet](https://github.com/pharmaverse/admiral/blob/main/inst/cheatsheet/admiral_cheatsheet.pdf) and make any required updates by re-generating it [here](https://phuseaccount.sharepoint.com/:f:/r/sites/Pharmaverse-admiral/Shared%20Documents/admiral/Cheatsheet?csf=1&web=1&e=APLtKF) and re-uploading it to the package.
