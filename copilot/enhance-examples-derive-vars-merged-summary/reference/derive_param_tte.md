...
- Restricting the source records by specifying/updating the `filter`
  argument in the
  [`event_source()`](https:/pharmaverse.github.io/admiral/copilot/enhance-examples-derive-vars-merged-summary/reference/event_source.md)/[`censor_source()`](https:/pharmaverse.github.io/admiral/copilot/enhance-examples-derive-vars-merged-summary/reference/censor_source.md)
  calls.
...
[`vignette("bds_tte")`](https:/pharmaverse.github.io/admiral/copilot/enhance-examples-derive-vars-merged-summary/articles/bds_tte.md).
