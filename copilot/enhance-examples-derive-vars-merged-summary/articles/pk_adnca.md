...
|------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|
| [`ADPC`](https:/pharmaverse.github.io/admiral/cran-release/copilot/enhance-examples-derive-vars-merged-summary/articles/templates.html#adpc)   | `use_ad_template("ADPC")`  |
| [`ADPPK`](https:/pharmaverse.github.io/admiral/cran-release/copilot/enhance-examples-derive-vars-merged-summary/articles/templates.html#adppk) | `use_ad_template("ADPPK")` |
