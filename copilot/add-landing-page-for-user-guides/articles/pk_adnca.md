...
|------------------------------------------------------------------------------------------------------------------------|----------------------------|
| [`ADPC`](https:/pharmaverse.github.io/admiral/copilot/add-landing-page-for-user-guides/articles/templates.html#adpc)   | `use_ad_template("ADPC")`  |
| [`ADPPK`](https:/pharmaverse.github.io/admiral/copilot/add-landing-page-for-user-guides/articles/templates.html#adppk) | `use_ad_template("ADPPK")` |
