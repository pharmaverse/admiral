...
Imputation](https:/pharmaverse.github.io/admiral/copilot/add-landing-page-for-user-guides/articles/imputation.Rmd)
...
|----------------------------------------------------------------------------------------------------------------------|---------------------------|
| [`ADEX`](https:/pharmaverse.github.io/admiral/copilot/add-landing-page-for-user-guides/articles/templates.html#adex) | `use_ad_template("ADEX")` |
