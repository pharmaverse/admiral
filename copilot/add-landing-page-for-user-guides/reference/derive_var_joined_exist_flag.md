...
- order:
  ...
  section in
  [`vignette("generic")`](https:/pharmaverse.github.io/admiral/copilot/add-landing-page-for-user-guides/articles/generic.md).
...
### Considering order of values ([`min_cond()`](https:/pharmaverse.github.io/admiral/copilot/add-landing-page-for-user-guides/reference/min_cond.md), [`max_cond()`](https:/pharmaverse.github.io/admiral/copilot/add-landing-page-for-user-guides/reference/max_cond.md))
