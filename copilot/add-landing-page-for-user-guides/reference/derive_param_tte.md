...
- Restricting the source records by specifying/updating the `filter`
  argument in the
  [`event_source()`](https:/pharmaverse.github.io/admiral/copilot/add-landing-page-for-user-guides/reference/event_source.md)/[`censor_source()`](https:/pharmaverse.github.io/admiral/copilot/add-landing-page-for-user-guides/reference/censor_source.md)
  calls.
...
[`vignette("bds_tte")`](https:/pharmaverse.github.io/admiral/copilot/add-landing-page-for-user-guides/articles/bds_tte.md).
