...
- Restricting the source records by specifying/updating the `filter`
  argument in the
  [`event_source()`](https:/pharmaverse.github.io/admiral/copilot/feature-boiler-plate-language-function/reference/event_source.md)/[`censor_source()`](https:/pharmaverse.github.io/admiral/copilot/feature-boiler-plate-language-function/reference/censor_source.md)
  calls.
...
[`vignette("bds_tte")`](https:/pharmaverse.github.io/admiral/copilot/feature-boiler-plate-language-function/articles/bds_tte.md)
and
[`vignette("tte_analyses")`](https:/pharmaverse.github.io/admiral/copilot/feature-boiler-plate-language-function/articles/tte_analyses.md).
