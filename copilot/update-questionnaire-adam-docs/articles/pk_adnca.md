...
|----------------------------------------------------------------------------------------------------------------------|----------------------------|
| [`ADPC`](https:/pharmaverse.github.io/admiral/copilot/update-questionnaire-adam-docs/articles/templates.html#adpc)   | `use_ad_template("ADPC")`  |
| [`ADPPK`](https:/pharmaverse.github.io/admiral/copilot/update-questionnaire-adam-docs/articles/templates.html#adppk) | `use_ad_template("ADPPK")` |
