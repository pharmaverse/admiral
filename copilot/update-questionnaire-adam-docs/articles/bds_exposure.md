...
Imputation](https:/pharmaverse.github.io/admiral/copilot/update-questionnaire-adam-docs/articles/imputation.Rmd)
...
|--------------------------------------------------------------------------------------------------------------------|---------------------------|
| [`ADEX`](https:/pharmaverse.github.io/admiral/copilot/update-questionnaire-adam-docs/articles/templates.html#adex) | `use_ad_template("ADEX")` |
