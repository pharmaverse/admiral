...
- Restricting the source records by specifying/updating the `filter`
  argument in the
  [`event_source()`](https:/pharmaverse.github.io/admiral/copilot/update-questionnaire-adam-docs/reference/event_source.md)/[`censor_source()`](https:/pharmaverse.github.io/admiral/copilot/update-questionnaire-adam-docs/reference/censor_source.md)
  calls.
...
[`vignette("bds_tte")`](https:/pharmaverse.github.io/admiral/copilot/update-questionnaire-adam-docs/articles/bds_tte.md).
