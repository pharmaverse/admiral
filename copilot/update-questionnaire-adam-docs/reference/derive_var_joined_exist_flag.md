...
- order:
  ...
  section in
  [`vignette("generic")`](https:/pharmaverse.github.io/admiral/copilot/update-questionnaire-adam-docs/articles/generic.md).
...
### Considering order of values ([`min_cond()`](https:/pharmaverse.github.io/admiral/copilot/update-questionnaire-adam-docs/reference/min_cond.md), [`max_cond()`](https:/pharmaverse.github.io/admiral/copilot/update-questionnaire-adam-docs/reference/max_cond.md))
