...
[`format.basket_select()`](https:/pharmaverse.github.io/admiral/copilot/update-questionnaire-adam-docs/reference/format.basket_select.md),
[`signal_duplicate_records()`](https:/pharmaverse.github.io/admiral/copilot/update-questionnaire-adam-docs/reference/signal_duplicate_records.md)
