...
- order:
  ...
  section in
  [`vignette("generic")`](https:/pharmaverse.github.io/admiral/copilot/enhance-examples-derive-basetype-records/articles/generic.md).
...
### Considering order of values ([`min_cond()`](https:/pharmaverse.github.io/admiral/copilot/enhance-examples-derive-basetype-records/reference/min_cond.md), [`max_cond()`](https:/pharmaverse.github.io/admiral/copilot/enhance-examples-derive-basetype-records/reference/max_cond.md))
