...
### Note on usage versus [`derive_vars_joined()`](https:/pharmaverse.github.io/admiral/copilot/enhance-examples-derive-basetype-records/reference/derive_vars_joined.md)
