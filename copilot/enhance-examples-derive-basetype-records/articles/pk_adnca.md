...
|--------------------------------------------------------------------------------------------------------------------------------|----------------------------|
| [`ADPC`](https:/pharmaverse.github.io/admiral/copilot/enhance-examples-derive-basetype-records/articles/templates.html#adpc)   | `use_ad_template("ADPC")`  |
| [`ADPPK`](https:/pharmaverse.github.io/admiral/copilot/enhance-examples-derive-basetype-records/articles/templates.html#adppk) | `use_ad_template("ADPPK")` |
