...
1.  [`derive_param_computed()`](https:/pharmaverse.github.io/admiral/cran-release/copilot/enhance-examples-derive-basetype-records/reference/derive_param_computed.md)
