...
- The function
  [`extract_duplicate_records()`](https:/pharmaverse.github.io/admiral/cran-release/copilot/update-documentation-pk-nca/reference/extract_duplicate_records.md)
...
- Created unit tests for developer internal function
  [`get_imputation_target_date()`](https:/pharmaverse.github.io/admiral/cran-release/copilot/update-documentation-pk-nca/reference/get_imputation_target_date.md)
...
- [`derive_extreme_records()`](https:/pharmaverse.github.io/admiral/cran-release/copilot/update-documentation-pk-nca/reference/derive_extreme_records.md),
  [`derive_var_extreme_flag()`](https:/pharmaverse.github.io/admiral/cran-release/copilot/update-documentation-pk-nca/reference/derive_var_extreme_flag.md),[`derive_vars_joined()`](https:/pharmaverse.github.io/admiral/cran-release/copilot/update-documentation-pk-nca/reference/derive_vars_joined.md)
  and
  [`derive_vars_merged()`](https:/pharmaverse.github.io/admiral/cran-release/copilot/update-documentation-pk-nca/reference/derive_vars_merged.md)
...
- The functions
  [`assert_db_requirements()`](https:/pharmaverse.github.io/admiral/cran-release/copilot/update-documentation-pk-nca/reference/assert_db_requirements.md),
  [`assert_terms()`](https:/pharmaverse.github.io/admiral/cran-release/copilot/update-documentation-pk-nca/reference/assert_terms.md),
  `assert_valid_queries()`, `extend_source_datasets()`,
  [`filter_date_sources()`](https:/pharmaverse.github.io/admiral/cran-release/copilot/update-documentation-pk-nca/reference/filter_date_sources.md),
  [`validate_basket_select()`](https:/pharmaverse.github.io/admiral/cran-release/copilot/update-documentation-pk-nca/reference/validate_basket_select.md),
  [`validate_query()`](https:/pharmaverse.github.io/admiral/cran-release/copilot/update-documentation-pk-nca/reference/validate_query.md)
...
- The meaning of `date_imputation = "mid"` was clarified in the
  ...
  e.g. [`derive_vars_dtm()`](https:/pharmaverse.github.io/admiral/cran-release/copilot/update-documentation-pk-nca/reference/derive_vars_dtm.md).
...
- The `traceability_vars` argument in
  ...
  [`derive_var_extreme_dt()`](https:/pharmaverse.github.io/admiral/cran-release/copilot/update-documentation-pk-nca/reference/derive_var_extreme_dt.md)
  and
  [`derive_var_extreme_dtm()`](https:/pharmaverse.github.io/admiral/cran-release/copilot/update-documentation-pk-nca/reference/derive_var_extreme_dtm.md),users
...
- Function `derive_var_worst_flag()` has been deprecated, in favor of
  [`slice_derivation()`](https:/pharmaverse.github.io/admiral/cran-release/copilot/update-documentation-pk-nca/reference/slice_derivation.md)/[`derive_var_extreme_flag()`](https:/pharmaverse.github.io/admiral/cran-release/copilot/update-documentation-pk-nca/reference/derive_var_extreme_flag.md).
...
- Updates to date/time imputation functions
  ...
  - [`derive_vars_dt()`](https:/pharmaverse.github.io/admiral/cran-release/copilot/update-documentation-pk-nca/reference/derive_vars_dt.md)now
