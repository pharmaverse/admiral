...
### Note on usage versus [`derive_vars_joined()`](https:/pharmaverse.github.io/admiral/cran-release/copilot/update-documentation-pk-nca/reference/derive_vars_joined.md)
