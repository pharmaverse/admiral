...
Imputation](https:/pharmaverse.github.io/admiral/cran-release/copilot/update-documentation-pk-nca/articles/imputation.Rmd)
...
|------------------------------------------------------------------------------------------------------------------------------|---------------------------|
| [`ADEX`](https:/pharmaverse.github.io/admiral/cran-release/copilot/update-documentation-pk-nca/articles/templates.html#adex) | `use_ad_template("ADEX")` |
