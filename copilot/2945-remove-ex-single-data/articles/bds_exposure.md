...
Imputation](https:/pharmaverse.github.io/admiral/copilot/2945-remove-ex-single-data/articles/imputation.Rmd)
...
|----------------------------------------------------------------------------------------------------------------|---------------------------|
| [`ADEX`](https:/pharmaverse.github.io/admiral/copilot/2945-remove-ex-single-data/articles/templates.html#adex) | `use_ad_template("ADEX")` |
