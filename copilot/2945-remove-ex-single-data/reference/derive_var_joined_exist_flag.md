...
- order:
  ...
  section in
  [`vignette("generic")`](https:/pharmaverse.github.io/admiral/copilot/2945-remove-ex-single-data/articles/generic.md).
...
### Considering order of values ([`min_cond()`](https:/pharmaverse.github.io/admiral/copilot/2945-remove-ex-single-data/reference/min_cond.md), [`max_cond()`](https:/pharmaverse.github.io/admiral/copilot/2945-remove-ex-single-data/reference/max_cond.md))
