...
[`vignette("occds")`](https:/pharmaverse.github.io/admiral/copilot/2945-remove-ex-single-data/articles/occds.md).

A query dataset is expected as an input to this function. See the
[`vignette("queries_dataset")`](https:/pharmaverse.github.io/admiral/copilot/2945-remove-ex-single-data/articles/queries_dataset.md)
