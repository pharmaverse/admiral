...
- [`derive_var_atoxgr()`](https:/pharmaverse.github.io/admiral/cran-release/2952_tte/reference/derive_var_atoxgr.md)
  : Derive Lab High toxicity Grade 0 - 4 and Low Toxicity Grades 0 -
  (-4)

- [`derive_var_atoxgr_dir()`](https:/pharmaverse.github.io/admiral/cran-release/2952_tte/reference/derive_var_atoxgr_dir.md)
...
- [`default_qtc_paramcd()`](https:/pharmaverse.github.io/admiral/cran-release/2952_tte/reference/default_qtc_paramcd.md)
  : Get Default Parameter Code for Corrected QT
- [`derive_expected_records()`](https:/pharmaverse.github.io/admiral/cran-release/2952_tte/reference/derive_expected_records.md)
...
- [`derive_locf_records()`](https:/pharmaverse.github.io/admiral/cran-release/2952_tte/reference/derive_locf_records.md)
...
- [`derive_param_bsa()`](https:/pharmaverse.github.io/admiral/cran-release/2952_tte/reference/derive_param_bsa.md)
...
- [`derive_param_computed()`](https:/pharmaverse.github.io/admiral/cran-release/2952_tte/reference/derive_param_computed.md)
  ...
  Parameters
- [`derive_param_doseint()`](https:/pharmaverse.github.io/admiral/cran-release/2952_tte/reference/derive_param_doseint.md)
  : Adds a Parameter for Dose Intensity
- [`derive_param_exist_flag()`](https:/pharmaverse.github.io/admiral/cran-release/2952_tte/reference/derive_param_exist_flag.md)
  : Add an Existence Flag Parameter
- [`derive_param_exposure()`](https:/pharmaverse.github.io/admiral/cran-release/2952_tte/reference/derive_param_exposure.md)
  : Add an Aggregated Parameter and Derive the Associated Start and End
  Dates
- [`derive_param_framingham()`](https:/pharmaverse.github.io/admiral/cran-release/2952_tte/reference/derive_param_framingham.md)
...
- [`derive_param_qtc()`](https:/pharmaverse.github.io/admiral/cran-release/2952_tte/reference/derive_param_qtc.md)
  : Adds a Parameter for Corrected QT (an ECG measurement)
- [`derive_param_rr()`](https:/pharmaverse.github.io/admiral/cran-release/2952_tte/reference/derive_param_rr.md)
...
- [`country_code_lookup`](https:/pharmaverse.github.io/admiral/cran-release/2952_tte/reference/country_code_lookup.md)
  : Country Code Lookup
- [`dose_freq_lookup`](https:/pharmaverse.github.io/admiral/cran-release/2952_tte/reference/dose_freq_lookup.md)
...
- [`example_qs`](https:/pharmaverse.github.io/admiral/cran-release/2952_tte/reference/example_qs.md)
  :
...
- [`create_period_dataset()`](https:/pharmaverse.github.io/admiral/cran-release/2952_tte/reference/create_period_dataset.md)
...
- [`flag_event()`](https:/pharmaverse.github.io/admiral/cran-release/2952_tte/reference/flag_event.md)
  :
...
- [`death_event`](https:/pharmaverse.github.io/admiral/cran-release/2952_tte/reference/tte_source_objects.md)
  [`lastalive_censor`](https:/pharmaverse.github.io/admiral/cran-release/2952_tte/reference/tte_source_objects.md)
  [`ae_event`](https:/pharmaverse.github.io/admiral/cran-release/2952_tte/reference/tte_source_objects.md)
  [`ae_ser_event`](https:/pharmaverse.github.io/admiral/cran-release/2952_tte/reference/tte_source_objects.md)
  [`ae_gr1_event`](https:/pharmaverse.github.io/admiral/cran-release/2952_tte/reference/tte_source_objects.md)
  [`ae_gr2_event`](https:/pharmaverse.github.io/admiral/cran-release/2952_tte/reference/tte_source_objects.md)
  [`ae_gr3_event`](https:/pharmaverse.github.io/admiral/cran-release/2952_tte/reference/tte_source_objects.md)
  [`ae_gr4_event`](https:/pharmaverse.github.io/admiral/cran-release/2952_tte/reference/tte_source_objects.md)
  [`ae_gr5_event`](https:/pharmaverse.github.io/admiral/cran-release/2952_tte/reference/tte_source_objects.md)
  [`ae_gr35_event`](https:/pharmaverse.github.io/admiral/cran-release/2952_tte/reference/tte_source_objects.md)
  [`ae_sev_event`](https:/pharmaverse.github.io/admiral/cran-release/2952_tte/reference/tte_source_objects.md)
  [`ae_wd_event`](https:/pharmaverse.github.io/admiral/cran-release/2952_tte/reference/tte_source_objects.md)
  : Pre-Defined Time-to-Event Source Objects

### Other

- [`list_tte_source_objects()`](https:/pharmaverse.github.io/admiral/cran-release/2952_tte/reference/list_tte_source_objects.md)
  :
...
- [`compute_dtf()`](https:/pharmaverse.github.io/admiral/cran-release/2952_tte/reference/compute_dtf.md)
...
- [`compute_egfr()`](https:/pharmaverse.github.io/admiral/cran-release/2952_tte/reference/compute_egfr.md)
  ...
  Function
- [`compute_framingham()`](https:/pharmaverse.github.io/admiral/cran-release/2952_tte/reference/compute_framingham.md)
  : Compute Framingham Heart Study Cardiovascular Disease 10-Year Risk
  Score
- [`compute_map()`](https:/pharmaverse.github.io/admiral/cran-release/2952_tte/reference/compute_map.md)
  : Compute Mean Arterial Pressure (MAP)
- [`compute_qtc()`](https:/pharmaverse.github.io/admiral/cran-release/2952_tte/reference/compute_qtc.md)
  : Compute Corrected QT
- [`compute_qual_imputation()`](https:/pharmaverse.github.io/admiral/cran-release/2952_tte/reference/compute_qual_imputation.md)
  : Function to Impute Values When Qualifier Exists in Character Result
- [`compute_qual_imputation_dec()`](https:/pharmaverse.github.io/admiral/cran-release/2952_tte/reference/compute_qual_imputation_dec.md)
  : Compute Factor for Value Imputations When Character Value Contains
  \< or \>
- [`compute_rr()`](https:/pharmaverse.github.io/admiral/cran-release/2952_tte/reference/compute_rr.md)
  : Compute RR Interval From Heart Rate
- [`compute_scale()`](https:/pharmaverse.github.io/admiral/cran-release/2952_tte/reference/compute_scale.md)
  : Compute Scale Parameters
- [`transform_range()`](https:/pharmaverse.github.io/admiral/cran-release/2952_tte/reference/transform_range.md)
  : Transform Range
...
- [`yn_to_numeric()`](https:/pharmaverse.github.io/admiral/cran-release/2952_tte/reference/yn_to_numeric.md)
  :
...
- [`get_many_to_one_dataset()`](https:/pharmaverse.github.io/admiral/cran-release/2952_tte/reference/get_many_to_one_dataset.md)
  : Get Many to One Values that Led to a Prior Error
- [`get_one_to_many_dataset()`](https:/pharmaverse.github.io/admiral/cran-release/2952_tte/reference/get_one_to_many_dataset.md)
  : Get One to Many Values that Led to a Prior Error

### Utilities used within Derivation Functions

- [`extract_unit()`](https:/pharmaverse.github.io/admiral/cran-release/2952_tte/reference/extract_unit.md)
  : Extract Unit From Parameter Description
- [`get_flagged_records()`](https:/pharmaverse.github.io/admiral/cran-release/2952_tte/reference/get_flagged_records.md)
  : Create an Existence Flag
- [`get_not_mapped()`](https:/pharmaverse.github.io/admiral/cran-release/2952_tte/reference/get_not_mapped.md)
  : Get list of records not mapped from the lookup table.
- [`get_vars_query()`](https:/pharmaverse.github.io/admiral/cran-release/2952_tte/reference/get_vars_query.md)
  : Get Query Variables
...
- [`filter_exist()`](https:/pharmaverse.github.io/admiral/cran-release/2952_tte/reference/filter_exist.md)
...
- [`filter_not_exist()`](https:/pharmaverse.github.io/admiral/cran-release/2952_tte/reference/filter_not_exist.md)
  : Returns records that don't fit into existing by groups in a filtered
  source dataset
- [`filter_relative()`](https:/pharmaverse.github.io/admiral/cran-release/2952_tte/reference/filter_relative.md)
...
- [`chr2vars()`](https:/pharmaverse.github.io/admiral/cran-release/2952_tte/reference/chr2vars.md)
...
- [`` `%>%` ``](https:/pharmaverse.github.io/admiral/cran-release/2952_tte/reference/pipe.md)
  : Pipe operator
- [`desc`](https:/pharmaverse.github.io/admiral/cran-release/2952_tte/reference/reexport-desc.md)
  : dplyr desc
...
- [`get_summary_records()`](https:/pharmaverse.github.io/admiral/cran-release/2952_tte/reference/get_summary_records.md)
