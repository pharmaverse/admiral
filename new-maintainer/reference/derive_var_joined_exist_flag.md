...
- order:
  ...
  section in
  [`vignette("generic")`](https:/pharmaverse.github.io/admiral/new-maintainer/articles/generic.md).
...
### Considering order of values ([`min_cond()`](https:/pharmaverse.github.io/admiral/new-maintainer/reference/min_cond.md), [`max_cond()`](https:/pharmaverse.github.io/admiral/new-maintainer/reference/max_cond.md))
