...
- Restricting the source records by specifying/updating the `filter`
  argument in the
  [`event_source()`](https:/pharmaverse.github.io/admiral/new-maintainer/reference/event_source.md)/[`censor_source()`](https:/pharmaverse.github.io/admiral/new-maintainer/reference/censor_source.md)
  calls.
...
[`vignette("bds_tte")`](https:/pharmaverse.github.io/admiral/new-maintainer/articles/bds_tte.md)
and
[`vignette("tte_analyses")`](https:/pharmaverse.github.io/admiral/new-maintainer/articles/tte_analyses.md).
