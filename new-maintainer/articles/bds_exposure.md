...
Imputation](https:/pharmaverse.github.io/admiral/new-maintainer/articles/imputation.Rmd)
...
|--------------------------------------------------------------------------------------------|---------------------------|
| [`ADEX`](https:/pharmaverse.github.io/admiral/new-maintainer/articles/templates.html#adex) | `use_ad_template("ADEX")` |
