...
Imputation](https:/pharmaverse.github.io/admiral/3022_by_vars_event_joined/articles/imputation.Rmd)
...
|-------------------------------------------------------------------------------------------------------|---------------------------|
| [`ADEX`](https:/pharmaverse.github.io/admiral/3022_by_vars_event_joined/articles/templates.html#adex) | `use_ad_template("ADEX")` |
