...
### Add a new record for the worst observation using [`event()`](https:/pharmaverse.github.io/admiral/3022_by_vars_event_joined/reference/event.md) objects
...
### Events based on comparison across records ([`event_joined()`](https:/pharmaverse.github.io/admiral/3022_by_vars_event_joined/reference/event_joined.md))
...
`by_vars` argument in
[`event_joined()`](https:/pharmaverse.github.io/admiral/3022_by_vars_event_joined/reference/event_joined.md)
which overwrites the value specified in the `derive_extreme_events()`
call. There `by_vars = exprs(USUBJID, AVISITN)` is used because we want
to add a new records for each subject and visit. In
[`event_joined()`](https:/pharmaverse.github.io/admiral/3022_by_vars_event_joined/reference/event_joined.md),
...
with the next one. This ensures that missing visit like for subject 2
...
### Specifying different arguments across [`event()`](https:/pharmaverse.github.io/admiral/3022_by_vars_event_joined/reference/event.md) objects
