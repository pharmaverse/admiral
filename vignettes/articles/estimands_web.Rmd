...
* [Analysis Based on Intercurrent Events](#analysis_based_on_intercurrent_events)
  * [A Simple Time-To-Event Example](#a_simple_time_to_event_example)
  * [A More Complex Example Involving Imputation](#a_more_complex_example_involving_imputation)
  * [Further Examples](#further_examples)

# Data Setup {#data_setup}

The examples in this article require the following packages and datasets, but note
...
`ADSL` directly from SDTM datasets, provided no protocol-specific estimand rules
...
for how estimand analyses could be achieved using `{admiral}`.
