...
- The `master`, `devel` and `gh-pages` branches are under protection.  If you try and push changes to these branches you will get an error unless you are an administrator.  
...
You can also make use of the Git Tab within RStudio to commit your changes.  A benefit of using this Tab is being able to see your changes to the file with red and green highlighting.  
...
```{r, echo = FALSE}
    knitr::include_graphics("github_delete_branch.png", dpi = 144)
```
