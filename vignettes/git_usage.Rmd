...
- The `pre-release` branch is used to as an intermediate step to releasing the package from `main`.  More info in [Quarterly Release section](release_strategy.html#quarterly-release)
