...
- At least one reviewer must approve the Pull Request. Please review the [Pull Request Review Guidance](pr_review_guidance.html), which provides in depth guidance on doing a proper Pull Request. 
...
Once the review is completed, and the Pull Request is merged, the branch must be removed: the reviewer will click **Delete branch** in the Pull Request.
