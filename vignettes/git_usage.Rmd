...
The issue must be linked to the pull request in the "Linked issues" field of the
Pull Request.
...
Once the review is completed, the reviewer will merge the Pull Request and click
**Delete branch** in the Pull Request.
...
"Sprint Done" column on the "admiral scrum board". The issue must not be closed.
It will be closed automatically once the `devel` branch is merged to the `main`
branch.
