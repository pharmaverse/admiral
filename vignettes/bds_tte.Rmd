...
dataset_vignette(
  adtte,
  display_vars = exprs(!!!get_admiral_option("subject_keys"), PARAMCD, PARAM, STARTDT, ADT, CNSR)
)
```
...
dataset_vignette(
  adsl,
  display_vars = exprs(!!!get_admiral_option("subject_keys"), DTHFL, DTHDT, TRTSDT, TRTSDTF)
)
```
...
dataset_vignette(
  adrs,
  display_vars = exprs(!!!get_admiral_option("subject_keys"), AVALC, ADT, ASEQ, PARAMCD, PARAM)
)
```
...
dataset_vignette(
  ...
  display_vars = exprs(!!!get_admiral_option("subject_keys"), PARAMCD, STARTDT, ADT, ADTF, CNSR)
)
```
...
adaette %>%
  ...
  dataset_vignette(display_vars = exprs(!!!get_admiral_option("subject_keys"), PARAMCD, STARTDT, ADT, CNSR, EVNTDESC, SRCDOM, SRCVAR))
```
...
dataset_vignette(
  ...
  display_vars = exprs(!!!get_admiral_option("subject_keys"), STARTDT, PARAMCD, PARAM, ADT, CNSR, SRCSEQ)
)
```
...
dataset_vignette(
  adtte,
  display_vars = exprs(!!!get_admiral_option("subject_keys"), PARAMCD, CNSR, AVAL, ARMCD, AGE, SEX)
)
```
