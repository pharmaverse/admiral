...
dataset_vignette(
  pc_dates,
  display_vars = exprs(
    !!!get_admiral_option("subject_keys"), PCTEST, ADTM, VISIT, PCTPT, NFRLT
  )
)
```
...
dataset_vignette(
  ex_dates,
  display_vars = exprs(
    !!!get_admiral_option("subject_keys"), EXTRT, EXDOSFRQ, ASTDTM, AENDTM, VISIT, VISITDY, NFRLT
  )
)
```
...
ex_exp <- ex_dates %>%
  create_single_dose_dataset(
    ...
    keep_source_vars = exprs(
      STUDYID, !!!get_admiral_option("subject_keys"), EVID, EXDOSFRQ, EXDOSFRM,
...
dataset_vignette(
  ex_exp,
  display_vars = exprs(
    !!!get_admiral_option("subject_keys"), DRUG, EXDOSFRQ, ASTDTM, AENDTM, AVISIT, NFRLT
  )
)
```
...
dataset_vignette(
  adpc_first_dose,
  display_vars = exprs(
    !!!get_admiral_option("subject_keys"), FANLDTM, AVISIT, ADTM, PCTPT
  )
)
```
...
dataset_vignette(
  adpc_prev,
  display_vars = exprs(
    !!!get_admiral_option("subject_keys"), VISIT, ADTM, VISIT, PCTPT, ADTM_prev, EXDOSE_prev, AVISIT_prev
  )
)
```
...
dataset_vignette(
  adpc_arrlt,
  display_vars = exprs(
    !!!get_admiral_option("subject_keys"), FANLDTM, AVISIT, PCTPT, AFRLT, ARRLT, AXRLT
  )
)
```
...
dataset_vignette(
  adpc_nrrlt,
  display_vars = exprs(
    !!!get_admiral_option("subject_keys"), AVISIT, PCTPT, NFRLT, NRRLT, NXRLT
  )
)
```
...
dataset_vignette(
  adpc_aval,
  display_vars = exprs(
    !!!get_admiral_option("subject_keys"), NFRLT, AVISIT, ATPT, ABLFL, ATPTREF, AVAL, AVALCAT1
  )
)
```
...
dataset_vignette(
  dtype,
  display_vars = exprs(
    !!!get_admiral_option("subject_keys"), DTYPE, ATPT, NFRLT, NRRLT, AFRLT, ARRLT, BASETYPE
  )
)
```
...
adpc_dtype %>%
  dataset_vignette(display_vars = exprs(
    !!!get_admiral_option("subject_keys"), BASETYPE, ADTM, ATPT, NFRLT, NRRLT, ARRLT, MRRLT
  ))
```
...
adpc_aseq %>%
  dataset_vignette(display_vars = exprs(
    !!!get_admiral_option("subject_keys"), BASETYPE, DTYPE, AVISIT, ATPT, AVAL, NFRLT, NRRLT, AFRLT, ARRLT, BASE, CHG
  ))
```
...
adpc_baselines %>%
  dataset_vignette(display_vars = exprs(
    !!!get_admiral_option("subject_keys"), HTBL, HTBLU, WTBL, WTBLU, BMIBL, BMIBLU, BASETYPE, ATPT, AVAL
  ))
```
...
dataset_vignette(
  adppk_nom_prev,
  display_vars = exprs(
    !!!get_admiral_option("subject_keys"), VISIT, ADTM, VISIT, PCTPT, ADTM_prev, NFRLT_prev
  )
)
```
...
dataset_vignette(
  adppk_aprlt,
  display_vars = exprs(
    !!!get_admiral_option("subject_keys"), EVID, NFRLT, AFRLT, APRLT, NPRLT
  )
)
```
...
dataset_vignette(
  adppk_aval,
  display_vars = exprs(
    !!!get_admiral_option("subject_keys"), EVID, DOSEA, AMT, NFRLT, AFRLT, CMT, DV, MDV, BLQFN
  )
)
```
...
dataset_vignette(
  adppk_aseq,
  display_vars = exprs(
    !!!get_admiral_option("subject_keys"), EVID, DOSEA, AMT, NFRLT, AFRLT, CMT, DV, MDV, BLQFN, ASEQ
  )
)
```
