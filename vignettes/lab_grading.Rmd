...
shifts from baseline. For directional toxicity grading, split variables are utilized for 
directionality: `BTOXGRL` (Baseline Toxicity Grade Low) and `BTOXGRH` (Baseline Toxicity Grade High).
