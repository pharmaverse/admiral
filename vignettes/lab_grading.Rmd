...
Within the ADLB VAD there is a concept of lab grading, where there is a set of criteria 
for particular lab tests that grade the severity or abnormality of a lab value. The 
...
sets of lab grading criteria, for the initial implementation of lab grading we will
...
Please see `SI_UNIT_CHECK` variable in {admiral} metadata `atoxgr_criteria_ctcv4`.
