...
NCI-CTCAEv4
  ...
  + `atoxgr_criteria_ctcv4()_uscv` for US (conventional) units.

NCI-CTCAEv5
  + `atoxgr_criteria_ctcv5()` for SI units.
  + `atoxgr_criteria_ctcv5()_uscv` for US (conventional) units.

DAIDS
  + `atoxgr_criteria_daids()` for SI units.
  + `atoxgr_criteria_daids()_uscv` for US (conventional) units.
