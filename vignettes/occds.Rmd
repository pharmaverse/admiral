...
dataset_vignette(
  adae,
  display_vars = exprs(
    !!!get_admiral_option("subject_keys"), AESEQ, AETERM, AESTDTC, TRTSDT,
...
dataset_vignette(
  adae,
  display_vars = exprs(
    !!!get_admiral_option("subject_keys"), AESTDTC, AEENDTC, ASTDTM, ASTDT,
...
dataset_vignette(
  adae,
  display_vars = exprs(
    !!!get_admiral_option("subject_keys"), AESTDTC, AEENDTC, ASTDT, AENDT,
    ADURN, ADURU
  )
)
```
...
dataset_vignette(
  adae,
  display_vars = exprs(
    !!!get_admiral_option("subject_keys"), TRTSDT, TRTEDT, AESTDTC, ASTDT,
    TRTEMFL
  )
)
```
...
dataset_vignette(
  adae,
  display_vars = exprs(
    !!!get_admiral_option("subject_keys"), ASTDTM, ASEV, AESEQ, TRTEMFL, AOCCIFL
  )
)
```
...
dataset_vignette(
  adae,
  display_vars = exprs(
    !!!get_admiral_option("subject_keys"), AEDECOD, ASTDTM, DTHDT, RFSTDTC,
