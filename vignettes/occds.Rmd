...
The expected result is the input dataset with query variables added.
...
head(select(adae, USUBJID, ASTDTM, AETERM, AESEQ, AEDECOD, AELLT, AELLTCD, SMQ02NAM, SMQ02SCN, SMQ03CD))
```

Similarly to SMQ, we use the `derive_vars_query()` function is used to derive SDG Standardized 
Drug Grouping.
...
sdg <- tibble::tribble(
  ...
  "SDG01",     "Diuretics",       12,      "BROAD",      2,                "CMDECOD",   "Diuretic 2",       NA,
  "SDG02",     "Costicosteroids", 13,      "BROAD",      1,                "CMDECOD",   "Costicosteroid 1", NA,
  "SDG02",     "Costicosteroids", 14,      "BROAD",      2,                "CMDECOD",   "Costicosteroid 2", NA,
  "SDG02",     "Costicosteroids", 14,      "BROAD",      2,                "CMDECOD",   "Costicosteroid 3", NA,
)          
adcm <- tibble::tribble(
  ~USUBJID, ~ASTDTM,               ~CMDECOD, ~CMSEQ,
  "01",     "2020-06-02 23:59:59", "Diuretic 1", 3,
  "02",     "2020-06-05 23:59:59", "Diuretic 1", 5,
  "03",     "2020-06-07 23:59:59", "Costicosteroid 2", 2,
  "05",     "2020-06-09 23:59:59", "Diuretic 2", 7,
)
