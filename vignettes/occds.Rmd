...
In this example, the exposure records are expanded to one record per day and
the join compares `ASTDTM` against day-level treatment windows (`EXSTDTM` to
`EXENDTM`). If your exposure records already represent single doses or include
true dosing times, adapt this logic to your study data.
