...
It is sometimes necessary to add dictionary query variables to an ADaM. For example, in ADAE, MedDRA SMQs and/or Customized Query variables may be needed. This function expects the dictionary and/or lookup information to be provided as input in a standard structure.
The expected result is the input dataset with query variables derived
