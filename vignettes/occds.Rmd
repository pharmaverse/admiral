...
dataset_vignette(
  adae,
  display_vars = c(get_admiral_option("subject_keys"), exprs(AESEQ, AETERM, AESTDTC, TRTSDT,
...
dataset_vignette(
  ...
  display_vars = c(get_admiral_option("subject_keys"),
                   exprs(AESTDTC, AEENDTC, ASTDTM, ASTDT,
...
dataset_vignette(
  adae,
  display_vars = c(get_admiral_option("subject_keys"),
                   exprs(AESTDTC, AEENDTC, ASTDT, AENDT,
    ADURN, ADURU
    )
  )
)
...
dataset_vignette(
  adae,
  display_vars = c(get_admiral_option("subject_keys"),
                   exprs(AEDECOD, AESEQ, AESTDTC, AEENDTC,
...
dataset_vignette(
  adae,
  display_vars = c(get_admiral_option("subject_keys"),
                   exprs(TRTSDT, TRTEDT, AESTDTC, ASTDT,
    TRTEMFL
    )
  )
)
...
dataset_vignette(
  adae,
  display_vars = c(
    get_admiral_option("subject_keys"), exprs(AEDECOD, ASTDTM, DTHDT, RFSTDTC,
