...
sdg <- tibble::tribble(
  ...
  "SDG01", "Dermatolo", 11,
  "BROAD", 1, "CMDECOD", "CMNAME", 1,
  "SDG02", "Dermatolo", 12,
  "BROAD", 2, "CMDECOD", "CMNAME", 2,
  "SDG03", "Dermatolo", 13,
  "BROAD", 1, "CMDECOD", "CMNAME", 3,
  "SDG04", "Dermatolo", 14,
  "BROAD", 2, "CMDECOD", "CMNAME", 4,
)
adcm <- tibble::tribble(
  ~USUBJID, ~ASTDTM, ~CMTERM, ~CMSEQ, ~CMDECOD, ~CMLLT,    ~CMLLTCD,
  "01", "2020-06-02 23:59:59", "ALANINE AMINOTRANSFERASE   ABNORMAL",
  3, "Alanine aminotransferase abnormal", NA_character_,   NA_integer_,
  "02", "2020-06-05 23:59:59", "BASEDOW'S DISEASE",
  5, "Basedow's disease", NA_character_, 1L,
