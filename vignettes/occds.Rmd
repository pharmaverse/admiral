...
Before deriving the last dose date, an `ex_single` dataset is created from the
...
the data cut-off date) before calling `create_single_dose_dataset()`. For a detailed discussion of dose expansion, including guidance on handling
missing end dates for ongoing studies, see `vignette("pk_adnca", package = "admiral")`.
