...
##### Admiral states it has **generalized functions to facilitate ADaMs**, what does that mean?
...
* Functions  are usually  generalized  and not specific. (see [Admiral states it has **generalized functions to facilitate ADaMs**, what does that mean?])
...
* The guidance will also highlight the gaps to be filled by the user (e.g. timing variables, visit windows).
* For heavily standardized ADaM datasets (ADAE, ADCM ...) we can provide an estimated coverage based on testing and user feedback 
* The ADaM IG implementations might vary from company to company, so numbers are estimates
