...
##### **Why** did we decide to start **admiral**?
  ...
  * the long-term gain of a consistent way of producing ADaM and a wider community of across-industry developers contributing to grow the code base to cover the infinite array of possibilities
 ...
 * Functions  are usually  generalized  and not specific. (see [Admiral offers a **toolbox of functions to facilitate ADaM**. What does that mean?](https://pharmaverse.github.io/admiral/articles/faq.html#admiral-offers-a-toolbox-of-functions-to-facilitate-adam--what-does-that-mean))
...
* Some tester quotes:
  ...
  * _"I am a huge proponent of shared solutions within Pharma. Overall I was VERY impressed with the `{admiral}` project -- both the design, development, documentation, and validation details are available for teams to readily adopt. Prior to participating in the testing, I was a SAS hold-out who wasn't able to see a strong need to shift to R. This project has shown me a reason to consider making the shift."_
