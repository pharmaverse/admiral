...
model](https://pharmaverse.github.io/admiral/main/articles/contribution_model.html) and you’re ready to make your first code
...
1. Before making a pull request, check the [Pull Request Review Guidance](pr_review_guidance.html) & the following checklist of common things developers miss:
    ...
    a. Does your code update have any impact on the [ADaM
    template](https://pharmaverse.github.io/admiral/main/articles/admiral.html#starting-a-script)
