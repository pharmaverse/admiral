...
If a function is defined in a file named `R/derive_var_baseline.R` then its accompanying unit tests should be stored in `tests/testthat/test-derive_var_baseline.R`.
