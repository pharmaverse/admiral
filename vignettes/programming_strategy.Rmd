...
reference to the input which caused the failure. This should avoid the users have to dig into detailed
code if they only want to apply a function. This supports usability.
