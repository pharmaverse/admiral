...
as `admiral` user-facing functions base totals above 125 and is growing!  However, to ease the burden for developers, we have decided that
...
| `der_gen`                                                                         | General Derivation Functions that can used for any ADaM.                                                                 |
...
| `bye_fcn_amd_dev` 	                                                              | Functions moved to `admiraldev` package [Link TBA]                                                                       |	
| `occds`                                                                           | OCCDS specific derivation of helper Functions                                                                            |
| `internal`                                                                        | Internal functions only available to admiral developers                                                                  |

**NOTE:** Each keyword and family are to be identical to ease burden of development and maintenance of `admiral` functions.  
