...
variables must be created using `get_new_tmp_var()` and must be removed from the output dataset using `remove_tmp_vars()`
...
-  **Phase 3:** Finally in the 3rd release thereafterthe function will be removed from the package altogether
