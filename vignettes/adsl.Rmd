...
If you have partial dates and are in need of imputation then please see the `derive_vars_dt()` documentation and examples for more details or check out the [Date and Time Imputation](imputation.html) vignette. 
