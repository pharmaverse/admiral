...
Typically, days of birth are collected only as years. However, this data has complete birth dates.  The function `derive_vars_dt()` has the flexibility to do imputation on partial date.  Please see the `derive_vars_dt()` documentation and examples for more details.
