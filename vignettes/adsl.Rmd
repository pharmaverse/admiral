...
dm <- admiral_dm %>% convert_blanks_to_na()
ds <- admiral_ds %>% convert_blanks_to_na()
ex <- admiral_ex %>% convert_blanks_to_na()
ae <- admiral_ae %>% convert_blanks_to_na()
lb <- admiral_lb %>% convert_blanks_to_na()
```
...
The function `derive_vars_merged()` can be used to derive a disposition reason (along with the details, if required) at a specific timepoint. 
