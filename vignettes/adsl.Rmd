...
[metacore](https://atorus-research.github.io/metacore/) objects are used to add
labels based on a specification file.

- [xportr](https://atorus-research.github.io/xportr/):
[metacore](https://atorus-research.github.io/metacore/) objects are used to add
labels and attributes based on a specification file. It also provides
functionality to create SAS transport files.
