...
if ([grepl](https://rdrr.io/r/base/grep.html)("^3.6", r_version)) {
  [options](https://rdrr.io/r/base/options.html)(repos = "https://cran.microsoft.com/snapshot/2020-02-29")
} else if ([grepl](https://rdrr.io/r/base/grep.html)("^4.0", r_version)) {
