...
if ([grepl](https://rdrr.io/r/base/grep.html)("^4.0", r_version)) {
  [options](https://rdrr.io/r/base/options.html)(repos = "https://cran.microsoft.com/snapshot/2021-03-31")
} else if ([grepl](https://rdrr.io/r/base/grep.html)("^4.1", r_version)) {
  [options](https://rdrr.io/r/base/options.html)(repos = "https://cran.microsoft.com/snapshot/2022-03-10")
} else if ([grepl](https://rdrr.io/r/base/grep.html)("^4.2", r_version)) {
  [options](https://rdrr.io/r/base/options.html)(repos = "https://cran.microsoft.com/snapshot/2022-06-23")
} else {
  [options](https://rdrr.io/r/base/options.html)(repos = "https://cran.rstudio.com")
}
