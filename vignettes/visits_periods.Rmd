...
If we instead wish to use an ADSL dataset containing treatment start and end dates to create a phase reference dataset, we can do so by employing `create_period_ref()`. Here is an example command to achieve this goal:
