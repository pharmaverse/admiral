...
<img src="https://raw.githubusercontent.com/pharmaverse/admiral/main/inst/visit_periods/dummy_study_design.png" width="630" height="252"/>
...
period_ref <- ex %>%
  ...
  arrange(!!!get_admiral_option("subject_keys"), APERSDT) %>%
...
dataset_vignette(
  adsl2,
  display_vars = c(get_admiral_option("subject_keys"), exprs(AP01SDT, AP01EDT, AP02SDT, AP02EDT))
)
```
...
dataset_vignette(
  adsl,
  display_vars = c(get_admiral_option("subject_keys"), exprs(TRT01A, TRT02A, AP01SDT, AP01EDT, AP02SDT, AP02EDT))
)
```
