...
dataset_vignette(
  adsl2,
  display_vars = exprs(!!!get_admiral_option("subject_keys"), AP01SDT, AP01EDT, AP02SDT, AP02EDT)
)
```
...
dataset_vignette(
  adsl,
  display_vars = exprs(!!!get_admiral_option("subject_keys"), TRT01A, TRT02A, AP01SDT, AP01EDT, AP02SDT, AP02EDT)
)
```
