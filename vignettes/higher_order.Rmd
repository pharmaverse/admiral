...
vs_without <- vs %>%
  derive_var_extreme_flag(
    by_vars = exprs(!!!get_admiral_option("subject_keys"), VSTESTCD),
...
vs_without %>%
  ...
  dataset_vignette(
    display_vars = exprs(!!!get_admiral_option("subject_keys"), VSTESTCD, VSORRES, ALOFL, AHIFL),
...
ae %>%
  ...
  dataset_vignette(
    display_vars = exprs(!!!get_admiral_option("subject_keys"), AEDECOD, AESTDY, AESEQ, AESEV, AHSEVFL)
  )
```
...
ae %>%
  ...
  dataset_vignette(
    display_vars = exprs(!!!get_admiral_option("subject_keys"), AEDECOD, AESTDY, AESEQ, AESEV, AHSEV3FL)
  )
```
