...
1. The derivation function should be closely looked at to see if it can be generalized to other ADaM datsets.  If that is the case, then it should be moved to `{admiral}` core. If the function is very specific to onoclogy needs, then it should remain in `{admiralonco}`.
1. The `assert` custom checking functions should always live within `{admiraldev}` to stay with the family of `assertion` functions.
