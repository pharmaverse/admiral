...
pipeline under the umbrella of the [pharmaverse E2E example](https://pharmaverse.github.io/examples/adam/adsl).

# Example Script {#example}

ADaM                          | Sourcing Command
----------------------------- | --------------
[`ADEX`](templates.html#adex) | `use_ad_template("ADEX")`
