...
For example purpose, the CDISC Pilot SDTM and ADaM datasets---which are included in `{admiraltest}`---are used.
...
```
```{r echo=FALSE}
admiral_ex <- filter(admiral_ex, USUBJID %in% c('01-701-1015', '01-701-1023', '01-703-1086', '01-703-1096', '01-707-1037', '01-716-1024'))
```
...
```{r eval=FALSE}
ex <- derive_vars_suppqual(admiral_ex, admiral_suppex)
```
