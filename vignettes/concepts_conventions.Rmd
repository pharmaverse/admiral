...
An exception to the above principle is found in our approach to option (see `get_admiral_option()` and `set_admiral_options()`,
where we have certain pre-defined defaults with added flexibility to allow for user-defined defaults on commonly used function 
