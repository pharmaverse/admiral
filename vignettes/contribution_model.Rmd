...
# Basics
 * For each new contribution, the user or Data Scientist creates an issue on the issue tab on [Git](https://github.com/Roche-GSK/admiral/issues) to put it in our backlog. 
