...
data(vs)
vs <- tribble(
  ~STUDYID, ~USUBJID, ~VSTESTCD, ~VISIT, ~VSDTC,
  "omep_1", "01-701-1015", "WEIGHT", "BASELINE", "2013-12-26",
  "omep_1", "01-701-1015", "WEIGHT", "WEEK 2", "2014-01-14",
  "omep_1", "01-701-1016", "WEIGHT", "BASELINE", "2014-01-06",
  "omep_1", "01-701-1016", "WEIGHT", "WEEK 2", "2014-01-22",
)
```
...
dataset_vignette(
  vs1,
  display_vars = c(get_admiral_option("subject_keys"), exprs(VSTESTCD, VISIT, VSDTC, ADT)),
