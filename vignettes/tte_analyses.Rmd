...
- if it did not, the last time when it is known that the subject didn't had an event is set as the _censoring time_.
...
progression free survival (PFS) the event is defined as progression _or_ death.
...
TODO: Setting EVNTDESC for censoring is sometimes tricky. For example if you are deriving time to CHG >= 10 and want to distinguish subjects censored because they don't have a baseline value and subject censored because they don't have post-baseline values.
