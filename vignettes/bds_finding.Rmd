...
dataframes needed may be `vs`, `suppvs`, and `adsl`.
...
count(advs, VSTESTCD, PARAMCD, PARAM, PARAMN, PARCAT, PARCATN)

head(select(advs, USUBJID, VSTESTCD, PARAMCD, PARAM, PARAMN, PARCAT, PARCATN))
```
...
head(select(advs, USUBJID, BASETYPE, PARAMCD, ABLFL, BASE, BASEC))
```
