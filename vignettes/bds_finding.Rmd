...
dataset_vignette(
  advs,
  display_vars = exprs(!!get_admiral_option("subject_keys")[[2]], PARAMCD, ADT, TRTSDT, TRTEDT, ONTRTFL),
...
dataset_vignette(
  advs,
  display_vars = exprs(!!get_admiral_option("subject_keys")[[2]], ASTDT, AENDT, AP01SDT, AP01EDT, ONTR01FL)
)
```
...
dataset_vignette(
  advs,
  display_vars = exprs(!!get_admiral_option("subject_keys")[[2]], PARAMCD, AVAL, ANRLO, ANRHI, A1LO, A1HI, ANRIND),
  filter = PARAMCD == "DIABP" & VISIT == "WEEK 2"
)
```
...
dataset_vignette(
  advs,
  display_vars = exprs(!!get_admiral_option("subject_keys")[[2]], PARAMCD, ADT, AVISITN, ATPTN, VISIT, ADT, ASEQ),
...
dataset_vignette(
  advs,
  display_vars = exprs(!!get_admiral_option("subject_keys")[[2]], PARAMCD, AVAL, AVALCA1N, AVALCAT1),
...
dataset_vignette(
  advs,
  display_vars = exprs(!!get_admiral_option("subject_keys")[[2]], RFSTDTC, RFENDTC, DTHDTC, DTHFL, AGE, AGEU),
  filter = USUBJID == "01-701-1015"
)
```
...
dataset_vignette(
  ...
  display_vars = exprs(!!get_admiral_option("subject_keys")[[2]], PARAMCD, ADT, AVISITN, AVISIT, ATPTN, AVAL, DTYPE, ANL01FL),
