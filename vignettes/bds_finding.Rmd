...
dataset_vignette(
  advs,
  display_vars = c(get_admiral_option("subject_keys"), exprs(VSTESTCD, VSDTC, VISIT, TRTSDT, TRTEDT, TRT01A, TRT01P)),
...
dataset_vignette(
  advs,
  display_vars = c(get_admiral_option("subject_keys"), exprs(VISIT, VSDTC, ADT)),
...
dataset_vignette(
  advs,
  display_vars = c(get_admiral_option("subject_keys"), exprs(VISIT, VSDTC, ADT, ADTF)),
...
dataset_vignette(
  advs,
  display_vars = c(get_admiral_option("subject_keys"), exprs(VISIT, ADT, ADY, TRTSDT)),
  filter = USUBJID == "01-716-1024"
)
```
...
```{r, eval=TRUE, echo=FALSE}
advs_param <- distinct(advs, STUDYID, USUBJID, PARAMCD, VSTESTCD)

dataset_vignette(advs_param, display_vars = c(get_admiral_option("subject_keys"), exprs(VSTESTCD, PARAMCD)))
```
...
dataset_vignette(
  arrange(advs, USUBJID, VISITNUM, VSTPTNUM, ADT, PARAMCD),
  display_vars = c(get_admiral_option("subject_keys"), exprs(VSTESTCD, PARAMCD, VISIT, VSTPT, AVAL)),
...
adeg <- derive_param_qtc(
  adeg,
  by_vars = c(get_admiral_option("subject_keys"), exprs(VISIT)),
  method = "Fridericia",
...
dataset_vignette(
  advs,
  display_vars = c(get_admiral_option("subject_keys"), exprs(PARAMCD, ADT, TRTSDT, TRTEDT, ONTRTFL)),
...
advs <- tibble::tribble(
  ...
  "odr_1", "P01", ymd("2020-03-15"), ymd("2020-01-01"), ymd("2020-03-01"), ymd("2020-12-01"),
  "odr_1", "P02", ymd("2019-04-30"), ymd("2020-01-01"), ymd("2020-03-01"), ymd("2020-03-15"),
  "odr_1", "P03", ymd("2019-04-30"), ymd("2020-01-01"), ymd("2020-03-01"), NA,
)
```
...
dataset_vignette(
  advs,
  display_vars = c(get_admiral_option("subject_keys"), exprs(ASTDT, AENDT, AP01SDT, AP01EDT, ONTR01FL))
)
```
...
dataset_vignette(
  advs,
  display_vars = c(get_admiral_option("subject_keys"), exprs(PARAMCD, AVAL, ANRLO, ANRHI, A1LO, A1HI, ANRIND)),
  filter = PARAMCD == "DIABP" & VISIT == "WEEK 2"
)
```
...
dataset_vignette(
  advs,
  display_vars = c(get_admiral_option("subject_keys"), exprs(BASETYPE, PARAMCD, ADT, TRTSDT, ATPTN, TRTSDT, ABLFL)),
...
dataset_vignette(
  advs,
  display_vars = c(get_admiral_option("subject_keys"), exprs(BASETYPE, PARAMCD, ABLFL, BASE, ANRIND, BNRIND)),
  filter = PARAMCD == "DIABP" & VISIT %in% c("WEEK 2", "BASELINE")
)
```
...
dataset_vignette(
  advs,
  display_vars = c(get_admiral_option("subject_keys"), exprs(VISIT, BASE, AVAL, ANRLO, R2BASE, R01ANRLO)),
  filter = PARAMCD == "DIABP" & VISIT %in% c("WEEK 2", "WEEK 8")
)
```
...
advs <- restrict_derivation(
  ...
  derivation = derive_var_extreme_flag,
  args = params(
    by_vars = c(get_admiral_option("subject_keys"), exprs(BASETYPE, PARAMCD, AVISIT)),
...
advs <- slice_derivation(
  ...
  arrange(!!!get_admiral_option("subject_keys"), BASETYPE, PARAMCD, AVISIT)
```
...
dataset_vignette(
  advs,
  display_vars = c(get_admiral_option("subject_keys"), exprs(PARAMCD, AVISIT, AVAL, ADT, ATPTN, WORSTFL)),
...
dataset_vignette(
  advs,
  display_vars = c(get_admiral_option("subject_keys"), exprs(PARAMCD, ADT, AVISITN, ATPTN, VISIT, ADT, ASEQ)),
...
dataset_vignette(
  advs,
  display_vars = c(get_admiral_option("subject_keys"), exprs(PARAMCD, AVAL, AVALCA1N, AVALCAT1)),
...
dataset_vignette(
  advs,
  display_vars = c(get_admiral_option("subject_keys"),exprs(RFSTDTC, RFENDTC, DTHDTC, DTHFL, AGE, AGEU)),
  filter = USUBJID == "01-701-1015"
)
```
...
dataset_vignette(
  ...
  display_vars = c(get_admiral_option("subject_keys"), exprs(PARAMCD, ADT, AVISITN, AVISIT, ATPTN, AVAL, DTYPE, ANL01FL)),
...
advs_ex2 <- derive_summary_records(
  advs,
  dataset_add = advs,
  by_vars = c(get_admiral_option("subject_keys"), exprs(PARAMCD, VISITNUM, ADT)),
  set_values_to = exprs(
...
dataset_vignette(
  ...
  display_vars = c(get_admiral_option("subject_keys"), exprs(PARAMCD, VISITNUM, ADT, AVAL, DTYPE)),
  filter = USUBJID == "01-701-1015"
)
```
...
advs_ex3 <- derive_param_computed(
  advs,
  by_vars = c(get_admiral_option("subject_keys"), exprs(VISIT, ATPT)),
...
```{r, eval=TRUE, echo=FALSE}
dataset_vignette(
  arrange(advs_ex3, !!!get_admiral_option("subject_keys"), VISIT, ATPT, PARAMCD),
  display_vars = c(get_admiral_option("subject_keys"), exprs(PARAMCD, VISIT, ATPT, AVAL)),
