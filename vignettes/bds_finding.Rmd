...
derive_param_wbc_abs (dataset = adlb,
...
advs <- derive_vars_merged(advs_pre,
...
This function derives a character shift variable concatenating shift in values based on 
