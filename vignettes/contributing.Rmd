...
| assertion                                                                         | Returns an error message if TRUE                                                                                         |
| warning                                                                           | Returns a warning message based on invalid data input or if existing variables are overwritten.                          |
| predicates                                                                        | returns `TRUE` if the argument is a valid input, `FALSE` otherwise.                                                      |
...
that should be formatted according to the [roxygen2](https://cran.r-project.org/web/packages/roxygen2/vignettes/roxygen2.html) convention. 
