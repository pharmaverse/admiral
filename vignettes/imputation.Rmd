...
unknown. These times and date-times are represented by the POSIXct 
class in R, which stores date and time in seconds, so seconds will 
always be included in the time stamp of a *DTM variable.
