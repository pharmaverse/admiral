...
argument which can be set to `FALSE` in cases where seconds are expected.
...
`2019-10` is not imputed as `2019-11-11 12:34:00`. This ensures that collected
information is not changed by the imputation.

```{r}
ae <- tribble(
  ~AESTDTC,              ~TRTSDTM,
  "2019-08-09T12:34:34", ymd_hms("2019-11-11T12:34:34"),
  "2019-10",             ymd_hms("2019-11-11T12:34:00"),
  "2019-11",             ymd_hms("2019-11-11T12:34:00"),
  "2019-12-04",          ymd_hms("2019-11-11T12:34:00")
) %>%
  derive_vars_dtm(
    dtc = AESTDTC,
    new_vars_prefix = "AST",
...
ae <- tribble(
  ...
  "2019-08-09T12:34:00", ymd("2019-11-11"), ymd("2019-12-02"),
