...
also be parsed for timing values or to assign values for special visits (i.e. "End of Study", "Unscheduled").
...
As with `IS` dataset, `NFRLT` is assigned using `VISITDY` (or could substitute parsed `EX.VISIT` values).
...
dataset_vignette(
  main_aab,
  display_vars = exprs( USUBJID, VISIT, ADATYPE, ADAPARM, MRT, DTL, ABLFL, ADABLPFL, ADPBLPFL,
