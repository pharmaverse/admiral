...
[^1]: In the walkthrough below we will use the ADLB dataset created from the call `use_ad_template("adlb")`. Due to the size of the dataset, we only included the following USUBJID's: 
...
hylaw_records <- derive_vars_joined(
  ...
  new_vars = exprs(BILI_CRITFL = CRIT1FL),
  mode = "first"
)
```
