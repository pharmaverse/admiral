...
Within the {admiral} folder https://github.com/pharmaverse/admiral/tree/main/tests/testthat, 
...
If a dataset needs to be created for testing purpose, it should be done so using the function `tribble()` from the `tibble` package with the following command `tibble::tribble(<data here>)`.
