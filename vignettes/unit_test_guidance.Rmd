...
the correctitude of our tests. One of those is to keep your tests with low 
...
your function justifies it, e.g. see the test script: https://github.com/Roche-GSK/admiral/blob/master/tests/testthat/test-derive_extreme_flag.R.

## Exported Functions
Don’t forget to add a unit test for each exported function.

## Set up the Test Script
Within {admiral} folder https://github.com/Roche-GSK/admiral/tree/master/tests/testthat, 
add a script with the naming convention “test-<function name>.R” and use the 
following format:

```

context("test-<function name>")

test_that("<function name> Test 1: <Explanation of the test>", {
...
function and test ID included in title will also help with tracability.
