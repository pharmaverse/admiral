...
your function justifies it, e.g. see the test script: https://github.com/Roche-GSK/admiral/blob/main/tests/testthat/test-derive_var_extreme_flag.R.

## Exported Functions
Don’t forget to add a unit test for each exported function.

## Set up the Test Script
Within {admiral} folder https://github.com/Roche-GSK/admiral/tree/main/tests/testthat, 
