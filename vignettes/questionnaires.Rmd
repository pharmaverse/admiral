...
```{r echo=FALSE}
dataset_vignette(
  arrange(adqs, !!!get_admiral_option("subject_keys"), PARCAT1, ADY, PARAMCD),
  display_vars = c(get_admiral_option("subject_keys"), exprs(PARAMCD, PARAM, PARCAT1, AVALC, AVAL, ADY, AVISIT))
)
```
...
adgad7 <- adqs %>%
  ...
  derive_summary_records(
    dataset = .,
    dataset_add = .,
    by_vars = c(get_admiral_option("subject_keys"), exprs(AVISIT, ADT, ADY, TRTSDT, DTHCAUS)),
...
```{r echo=FALSE}
dataset_vignette(
  arrange(adgad7, !!!get_admiral_option("subject_keys"), ADY, PARAMCD),
  display_vars = c(get_admiral_option("subject_keys"), exprs(PARAMCD, PARAM, AVAL, ADY, AVISIT))
)
```
...
```{r echo=FALSE}
dataset_vignette(
  arrange(adgdssf, !!!get_admiral_option("subject_keys"), ADY, PARAMCD),
  display_vars = c(get_admiral_option("subject_keys"), exprs(PARAMCD, PARAM, AVAL, ADY, AVISIT))
)
```
...
```{r echo=FALSE}
dataset_vignette(
  arrange(adgdssf, !!!get_admiral_option("subject_keys"), desc(PARAMCD), ADY),
  display_vars = c(get_admiral_option("subject_keys"), exprs(PARAMCD, PARAM, AVISIT, AVAL, AVALCAT1, CHGCAT1))
)
```
...
dataset_vignette(
  adgdstte,
  display_vars = c(get_admiral_option("subject_keys"), exprs(PARAMCD, PARAM, AVAL, CNSR, EVNTDESC, SRCDOM, SRCVAR))
)
```
...
dataset_vignette(
  arrange(adgdssf, !!!get_admiral_option("subject_keys"), desc(PARAMCD), ADY),
  display_vars = c(get_admiral_option("subject_keys"), exprs(PARAMCD, PARAM, ADY, CHGCAT1, CDETFL))
)
```
...
dataset_vignette(
  arrange(adgdssf, !!!get_admiral_option("subject_keys"), desc(PARAMCD), ADY),
  display_vars = c(get_admiral_option("subject_keys"), exprs(PARAMCD, PARAM, ADY, CHGCAT1, CONDETFL, CDTDTHFL))
)
```
...
dataset_vignette(
  arrange(adgdssf, !!!get_admiral_option("subject_keys"), desc(PARAMCD), ADY),
  display_vars = c(get_admiral_option("subject_keys"), exprs(PARAMCD, PARAM, ADY, CHGCAT1, DEFDETFL))
)
```
...
```{r echo=FALSE}
dataset_vignette(
  arrange(adsp, !!!get_admiral_option("subject_keys"), ADY, PARAMCD),
  display_vars = c(get_admiral_option("subject_keys"), exprs(PARAMCD, PARAM, AVISIT, AVALC))
)
```
...
```{r echo=FALSE}
dataset_vignette(
  arrange(adgdssf, !!!get_admiral_option("subject_keys"), PARAMCD, ADY),
  display_vars = c(get_admiral_option("subject_keys"), exprs(PARAMCD, PARAM, AVISIT, AVALC))
)
```
