...
dataset_vignette(
  ...
  display_vars = exprs(!!!get_admiral_option("subject_keys"), PARAMCD, PARAM, PARCAT1, AVALC, AVAL, ADY, AVISIT)
)
```
...
adgad7 <- adqs %>%
  ...
  derive_summary_records(
    dataset = .,
    dataset_add = .,
    by_vars = exprs(!!!get_admiral_option("subject_keys"), AVISIT, ADT, ADY, TRTSDT, DTHCAUS),
...
dataset_vignette(
  ...
  display_vars = exprs(!!!get_admiral_option("subject_keys"), PARAMCD, PARAM, AVAL, ADY, AVISIT)
)
```
...
dataset_vignette(
  ...
  display_vars = exprs(!!!get_admiral_option("subject_keys"), PARAMCD, PARAM, AVISIT, AVAL, AVALCAT1, CHGCAT1)
)
```
...
dataset_vignette(
  adgdstte,
  display_vars = exprs(!!!get_admiral_option("subject_keys"), PARAMCD, PARAM, AVAL, CNSR, EVNTDESC, SRCDOM, SRCVAR)
)
```
...
dataset_vignette(
  arrange(adgdssf, USUBJID, desc(PARAMCD), ADY),
  display_vars = exprs(!!!get_admiral_option("subject_keys"), PARAMCD, PARAM, ADY, CHGCAT1, CDETFL)
)
```
...
dataset_vignette(
  arrange(adgdssf, USUBJID, desc(PARAMCD), ADY),
  display_vars = exprs(!!!get_admiral_option("subject_keys"), PARAMCD, PARAM, ADY, CHGCAT1, CONDETFL, CDTDTHFL)
)
```
...
dataset_vignette(
  arrange(adgdssf, USUBJID, desc(PARAMCD), ADY),
  display_vars = exprs(!!!get_admiral_option("subject_keys"), PARAMCD, PARAM, ADY, CHGCAT1, DEFDETFL)
)
```
...
adsp <- adqs %>%
  ...
  derive_extreme_event(
    by_vars = exprs(!!!get_admiral_option("subject_keys"), AVISIT),
...
dataset_vignette(
  ...
  display_vars = exprs(!!!get_admiral_option("subject_keys"), PARAMCD, PARAM, AVISIT, AVALC)
)
```
