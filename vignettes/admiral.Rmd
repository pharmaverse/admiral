...
symbols or expressions must be specified rather than strings. The `expr()` and
the `exprs()` function of the `rlang` package can be used to quote expressions
where necessary.
...
- See
[doc/inst/example_scripts](https://github.com/Roche-GSK/admiral/tree/master/inst/example_scripts)
for example scripts creating ADaM datasets.
