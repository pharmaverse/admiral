...
dataset_vignette(
  adsl,
  display_vars = get_admiral_option("subject_keys"), TRTSDTM, TRTSTMF)
)
```
...
advs <- advs %>%
  derive_param_computed(
    by_vars = get_admiral_option("subject_keys"), AVISIT, AVISITN),
...
advs %>%
  ...
  dataset_vignette(
    display_vars = get_admiral_option("subject_keys"), AVISIT, PARAMCD, AVAL)
  )
```
...
dataset_vignette(
  adsl,
  display_vars = get_admiral_option("subject_keys"), FINLABDT)
)
```
