...
unknown. These times and date-times are represented by the POSIXct class
in R, which stores date and time in seconds, so seconds will always be
included in the time stamp of a \*DTM variable.
...
e.g. [`impute_dtc_dtm()`](https:/pharmaverse.github.io/admiral/3055_derive_vars_dtm_doc_update/reference/impute_dtc_dtm.md),
[`derive_vars_dtm()`](https:/pharmaverse.github.io/admiral/3055_derive_vars_dtm_doc_update/reference/derive_vars_dtm.md),
...
e.g. [`impute_dtc_dt()`](https:/pharmaverse.github.io/admiral/3055_derive_vars_dtm_doc_update/reference/impute_dtc_dt.md),
[`derive_vars_dt()`](https:/pharmaverse.github.io/admiral/3055_derive_vars_dtm_doc_update/reference/derive_vars_dt.md)
