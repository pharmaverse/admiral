...
### Note on usage versus [`derive_vars_merged()`](https:/pharmaverse.github.io/admiral/3153_duplicates_from_call_derivation_example/reference/derive_vars_merged.md)
