...
-   [Code of
    Conduct](https://pharmaverse.github.io/admiraldev/main/CODE_OF_CONDUCT.html)
-   [Manifesto](https://pharmaverse.github.io/admiraldev/main/index.html#admiral-manifesto)
-   [Programming
...
5.  Each company should start to identify the required developer
    ...
    [site](https://pharmaverse.github.io/admiraldev/main/), especially
    the developer guides which all need to be followed for package
    extensions.
...
11. Set up a new public GitHub repo under the [pharmaverse
    ...
    versions. *Note that this step requires org member access which
...
12. Once the repo is available the technical lead could be granted admin
    ...
    only require write access, but you may choose to give the other
    leads admin access as well so that never a bottle-neck waiting on
    one person.
...
20. Raise an `{admiral}` repo issue to ensure your package extension
    ...
    [here.](https://pharmaverse.github.io/admiraldev/main/index.html#types-of-packages)
...
23. Plan any future further enhancements and make issues. When your team
    ...
    page.](https://pharmaverse.github.io/admiraldev/main/articles/contribution_model.html).
