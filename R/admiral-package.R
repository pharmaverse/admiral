...
#' @importFrom stringr str_c str_detect str_extract str_glue str_length
#'   str_locate str_match str_remove str_remove_all str_replace str_replace_all
#'   str_split str_starts str_sub str_subset str_trim str_to_lower str_to_title
#'   str_to_upper
