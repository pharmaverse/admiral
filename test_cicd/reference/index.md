...
- [`derive_basetype_records()`](https:/pharmaverse.github.io/admiral/test_cicd/test_cicd/reference/derive_basetype_records.md)
  : Derive Basetype Variable

- [`derive_var_analysis_ratio()`](https:/pharmaverse.github.io/admiral/test_cicd/test_cicd/reference/derive_var_analysis_ratio.md)
  : Derive Ratio Variable

- [`derive_var_anrind()`](https:/pharmaverse.github.io/admiral/test_cicd/test_cicd/reference/derive_var_anrind.md)
  : Derive Reference Range Indicator

- [`derive_var_atoxgr()`](https:/pharmaverse.github.io/admiral/test_cicd/test_cicd/reference/derive_var_atoxgr.md)
  : Derive Lab High toxicity Grade 0 - 4 and Low Toxicity Grades 0 -
  (-4)

- [`derive_var_atoxgr_dir()`](https:/pharmaverse.github.io/admiral/test_cicd/test_cicd/reference/derive_var_atoxgr_dir.md)
  : Derive Lab Toxicity Grade 0 - 4

- [`derive_var_base()`](https:/pharmaverse.github.io/admiral/test_cicd/test_cicd/reference/derive_var_base.md)
  : Derive Baseline Variables

- [`derive_var_chg()`](https:/pharmaverse.github.io/admiral/test_cicd/test_cicd/reference/derive_var_chg.md)
  : Derive Change from Baseline

- [`derive_var_nfrlt()`](https:/pharmaverse.github.io/admiral/test_cicd/test_cicd/reference/derive_var_nfrlt.md)
  **\[experimental\]** : Derive Nominal Relative Time from First Dose
  (NFRLT)

- [`derive_var_ontrtfl()`](https:/pharmaverse.github.io/admiral/test_cicd/test_cicd/reference/derive_var_ontrtfl.md)
  : Derive On-Treatment Flag Variable

- [`derive_var_pchg()`](https:/pharmaverse.github.io/admiral/test_cicd/test_cicd/reference/derive_var_pchg.md)
  : Derive Percent Change from Baseline

- [`derive_var_shift()`](https:/pharmaverse.github.io/admiral/test_cicd/test_cicd/reference/derive_var_shift.md)
  : Derive Shift

- [`derive_vars_crit_flag()`](https:/pharmaverse.github.io/admiral/test_cicd/test_cicd/reference/derive_vars_crit_flag.md)
  :
...
- [`derive_vars_atc()`](https:/pharmaverse.github.io/admiral/test_cicd/test_cicd/reference/derive_vars_atc.md)
...
- [`default_qtc_paramcd()`](https:/pharmaverse.github.io/admiral/test_cicd/test_cicd/reference/default_qtc_paramcd.md)
  : Get Default Parameter Code for Corrected QT
- [`derive_expected_records()`](https:/pharmaverse.github.io/admiral/test_cicd/test_cicd/reference/derive_expected_records.md)
...
- [`derive_extreme_records()`](https:/pharmaverse.github.io/admiral/test_cicd/test_cicd/reference/derive_extreme_records.md)
  : Add the First or Last Observation for Each By Group as New Records
- [`derive_locf_records()`](https:/pharmaverse.github.io/admiral/test_cicd/test_cicd/reference/derive_locf_records.md)
  : Derive LOCF (Last Observation Carried Forward) Records
- [`derive_param_bmi()`](https:/pharmaverse.github.io/admiral/test_cicd/test_cicd/reference/derive_param_bmi.md)
  : Adds a Parameter for BMI
- [`derive_param_bsa()`](https:/pharmaverse.github.io/admiral/test_cicd/test_cicd/reference/derive_param_bsa.md)
  : Adds a Parameter for BSA (Body Surface Area) Using the Specified
  Method
- [`derive_param_computed()`](https:/pharmaverse.github.io/admiral/test_cicd/test_cicd/reference/derive_param_computed.md)
...
- [`derive_param_exposure()`](https:/pharmaverse.github.io/admiral/test_cicd/test_cicd/reference/derive_param_exposure.md)
  ...
  Dates
- [`derive_param_framingham()`](https:/pharmaverse.github.io/admiral/test_cicd/test_cicd/reference/derive_param_framingham.md)
...
- [`derive_param_qtc()`](https:/pharmaverse.github.io/admiral/test_cicd/test_cicd/reference/derive_param_qtc.md)
  : Adds a Parameter for Corrected QT (an ECG measurement)
- [`derive_param_rr()`](https:/pharmaverse.github.io/admiral/test_cicd/test_cicd/reference/derive_param_rr.md)
  : Adds a Parameter for Derived RR (an ECG measurement)
- [`derive_param_wbc_abs()`](https:/pharmaverse.github.io/admiral/test_cicd/test_cicd/reference/derive_param_wbc_abs.md)
...
- [`atoxgr_criteria_ctcv5_uscv`](https:/pharmaverse.github.io/admiral/test_cicd/test_cicd/reference/atoxgr_criteria_ctcv5_uscv.md)
  ...
  where applicable
- [`atoxgr_criteria_ctcv6`](https:/pharmaverse.github.io/admiral/test_cicd/test_cicd/reference/atoxgr_criteria_ctcv6.md)
...
You can run
[`use_ad_template()`](https:/pharmaverse.github.io/admiral/test_cicd/test_cicd/reference/use_ad_template.md)
...
- [`get_admiral_option()`](https:/pharmaverse.github.io/admiral/test_cicd/test_cicd/reference/get_admiral_option.md)
...
- [`restrict_derivation()`](https:/pharmaverse.github.io/admiral/test_cicd/test_cicd/reference/restrict_derivation.md)
...
- [`death_event`](https:/pharmaverse.github.io/admiral/test_cicd/test_cicd/reference/tte_source_objects.md)
  [`lastalive_censor`](https:/pharmaverse.github.io/admiral/test_cicd/test_cicd/reference/tte_source_objects.md)
  [`ae_event`](https:/pharmaverse.github.io/admiral/test_cicd/test_cicd/reference/tte_source_objects.md)
  [`ae_ser_event`](https:/pharmaverse.github.io/admiral/test_cicd/test_cicd/reference/tte_source_objects.md)
  [`ae_gr1_event`](https:/pharmaverse.github.io/admiral/test_cicd/test_cicd/reference/tte_source_objects.md)
  [`ae_gr2_event`](https:/pharmaverse.github.io/admiral/test_cicd/test_cicd/reference/tte_source_objects.md)
  [`ae_gr3_event`](https:/pharmaverse.github.io/admiral/test_cicd/test_cicd/reference/tte_source_objects.md)
  [`ae_gr4_event`](https:/pharmaverse.github.io/admiral/test_cicd/test_cicd/reference/tte_source_objects.md)
  [`ae_gr5_event`](https:/pharmaverse.github.io/admiral/test_cicd/test_cicd/reference/tte_source_objects.md)
  [`ae_gr35_event`](https:/pharmaverse.github.io/admiral/test_cicd/test_cicd/reference/tte_source_objects.md)
  [`ae_sev_event`](https:/pharmaverse.github.io/admiral/test_cicd/test_cicd/reference/tte_source_objects.md)
  [`ae_wd_event`](https:/pharmaverse.github.io/admiral/test_cicd/test_cicd/reference/tte_source_objects.md)
  : Pre-Defined Time-to-Event Source Objects

### Other

- [`list_tte_source_objects()`](https:/pharmaverse.github.io/admiral/test_cicd/test_cicd/reference/list_tte_source_objects.md)
  :
...
- [`convert_na_to_blanks()`](https:/pharmaverse.github.io/admiral/test_cicd/test_cicd/reference/convert_na_to_blanks.md)
...
- [`get_many_to_one_dataset()`](https:/pharmaverse.github.io/admiral/test_cicd/test_cicd/reference/get_many_to_one_dataset.md)
  : Get Many to One Values that Led to a Prior Error
- [`get_one_to_many_dataset()`](https:/pharmaverse.github.io/admiral/test_cicd/test_cicd/reference/get_one_to_many_dataset.md)
  : Get One to Many Values that Led to a Prior Error

### Utilities used within Derivation Functions

- [`extract_unit()`](https:/pharmaverse.github.io/admiral/test_cicd/test_cicd/reference/extract_unit.md)
  : Extract Unit From Parameter Description
- [`get_flagged_records()`](https:/pharmaverse.github.io/admiral/test_cicd/test_cicd/reference/get_flagged_records.md)
  : Create an Existence Flag
- [`get_not_mapped()`](https:/pharmaverse.github.io/admiral/test_cicd/test_cicd/reference/get_not_mapped.md)
  : Get list of records not mapped from the lookup table.
- [`get_vars_query()`](https:/pharmaverse.github.io/admiral/test_cicd/test_cicd/reference/get_vars_query.md)
  : Get Query Variables
...
- [`chr2vars()`](https:/pharmaverse.github.io/admiral/test_cicd/test_cicd/reference/chr2vars.md)
  : Turn a Character Vector into a List of Expressions
- [`negate_vars()`](https:/pharmaverse.github.io/admiral/test_cicd/test_cicd/reference/negate_vars.md)
  : Negate List of Variables

### Utilities used for Examples and Template Scripts

- [`list_all_templates()`](https:/pharmaverse.github.io/admiral/test_cicd/test_cicd/reference/list_all_templates.md)
...
- [`` `%>%` ``](https:/pharmaverse.github.io/admiral/test_cicd/test_cicd/reference/pipe.md)
  : Pipe operator
- [`desc`](https:/pharmaverse.github.io/admiral/test_cicd/test_cicd/reference/reexport-desc.md)
  : dplyr desc
