...
[`vignette("occds")`](https:/pharmaverse.github.io/admiral/test_cicd/articles/occds.md).

A query dataset is expected as an input to this function. See the
[`vignette("queries_dataset")`](https:/pharmaverse.github.io/admiral/test_cicd/articles/queries_dataset.md)
