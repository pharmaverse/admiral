...
- The documentation for `derive_vars_dtm()` was updated to clarify details of the `highest_imputation` argument. (#3055)

- The 'Date and Time Imputation' vignette was updated to point out the difference between the character `*DTC` variables and the 
  numeric `*DTM` variables. (#3055)
