...
- New function `hello_admiral()` displays a welcome message to users of the admiral package and is used for on-boarding purposes [#1839](https://github.com/pharmaverse/admiral/issues/1839#event-17076591355).
