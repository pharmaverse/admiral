...
test_that("DTHCAUS and DTHDOM are added from AE and DS, info avaibale in the 2 input datasets for 1 pt.", { # nolint
  adsl <- tibble::tribble(
    ~STUDYID, ~USUBJID,
    "TEST01", "PAT01",
    "TEST01", "PAT02",
  ...
  ae <- tibble::tribble(
    ~STUDYID, ~USUBJID, ~AEDECOD, ~AEOUT, ~AEDTHDTC,
    "TEST01", "PAT01", "SUDDEN DEATH", "FATAL", "2021-04-04",
    "TEST01", "PAT03", "SUDDEN DEATH", "FATAL", "2021-04-04"
  )
  ...
  ds <- tibble::tribble(
    ...
    "TEST01", "PAT01", "RANDOMIZATION", "RANDOMIZATION", "2021-04-11",
    "TEST01", "PAT01", "ADVERSE EVENT", "ADVERSE EVENT", "2021-12-01",
    "TEST01", "PAT01", "DEATH", "DEATH DUE TO ADVERSE EVENT", "2021-04-03",
    "TEST01", "PAT02", "INFORMED CONSENT OBTAINED", "INFORMED CONSENT OBTAINED", "2021-04-02",
    "TEST01", "PAT02", "RANDOMIZATION", "RANDOMIZATION", "2021-04-11",
    "TEST01", "PAT02", "COMPLETED", "PROTOCOL COMPLETED", "2021-12-01",
    "TEST01", "PAT03", "INFORMED CONSENT OBTAINED", "INFORMED CONSENT OBTAINED", "2021-04-03",
  ...
  expected_output <- tibble::tribble(
    ~STUDYID, ~USUBJID, ~DTHDOM, ~DTHCAUS,
    "TEST01", "PAT01", "DS", "DEATH DUE TO ADVERSE EVENT",
    "TEST01", "PAT02", NA, NA,
    "TEST01", "PAT03", "AE", "SUDDEN DEATH"
  )
...
test_that("DTHCAUS and DTHDOM are added from AE and DS, partial dates in AE ", {
  adsl <- tibble::tribble(
    ~STUDYID, ~USUBJID,
    "TEST01", "PAT01",
    "TEST01", "PAT02",
  ...
  ae <- tibble::tribble(
    ~STUDYID, ~USUBJID, ~AEDECOD, ~AEOUT, ~AEDTHDTC,
    "TEST01", "PAT03", "SUDDEN DEATH", "FATAL", "2021-04"
  )
  ...
  ds <- tibble::tribble(
    ...
    "TEST01", "PAT01", "RANDOMIZATION", "RANDOMIZATION", "2021-04-11",
    "TEST01", "PAT01", "ADVERSE EVENT", "ADVERSE EVENT", "2021-12-01",
    "TEST01", "PAT01", "DEATH", "DEATH DUE TO PROGRESSION OF DISEASE", "2021-02-01",
    "TEST01", "PAT02", "INFORMED CONSENT OBTAINED", "INFORMED CONSENT OBTAINED", "2021-04-02",
    "TEST01", "PAT02", "RANDOMIZATION", "RANDOMIZATION", "2021-04-11",
    "TEST01", "PAT02", "COMPLETED", "PROTOCOL COMPLETED", "2021-12-01",
    "TEST01", "PAT03", "INFORMED CONSENT OBTAINED", "INFORMED CONSENT OBTAINED", "2021-04-03",
...
test_that("DTHCAUS and DTHDOM are added from AE and DS, info available in the 2 input datasets for 1 pt, partial date in DS", { # nolint
  adsl <- tibble::tribble(
    ~STUDYID, ~USUBJID,
    "TEST01", "PAT01",
    "TEST01", "PAT02",
  ...
  ae <- tibble::tribble(
    ~STUDYID, ~USUBJID, ~AEDECOD, ~AEOUT, ~AEDTHDTC,
    "TEST01", "PAT01", "SUDDEN DEATH", "FATAL", "2021-05-01",
    "TEST01", "PAT03", "SUDDEN DEATH", "FATAL", "2021-04-04"
  )
  ...
  ds <- tibble::tribble(
    ...
    "TEST01", "PAT01", "RANDOMIZATION", "RANDOMIZATION", "2021-04-11",
    "TEST01", "PAT01", "ADVERSE EVENT", "ADVERSE EVENT", "2021-12-01",
    "TEST01", "PAT01", "DEATH", "DEATH DUE TO ADVERSE EVENT", "2021-04",
    "TEST01", "PAT02", "INFORMED CONSENT OBTAINED", "INFORMED CONSENT OBTAINED", "2021-04-02",
    "TEST01", "PAT02", "RANDOMIZATION", "RANDOMIZATION", "2021-04-11",
    "TEST01", "PAT02", "COMPLETED", "PROTOCOL COMPLETED", "2021-12-01",
    "TEST01", "PAT03", "INFORMED CONSENT OBTAINED", "INFORMED CONSENT OBTAINED", "2021-04-03",
