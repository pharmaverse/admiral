...
test_that("derive_var_obs_number Test 1: create default new variable ASEQ", {
  input <- tibble::tribble(
    ...
    "TEST01",  "PAT01",   "DIABP",        1L,        1L,
    "TEST01",  "PAT01",   "PULSE",        1L,        1L,
    "TEST01",  "PAT01",   "PULSE",        1L,        2L,
    "TEST01",  "PAT01",   "PULSE",        2L,        1L,
    "TEST01",  "PAT01",   "PULSE",        2L,        2L,
    "TEST01",  "PAT01",   "SYSBP",        1L,        1L,
    "TEST01",  "PAT01",   "SYSBP",        1L,        2L,
    "TEST01",  "PAT01",   "SYSBP",        2L,        1L,
    "TEST01",  "PAT02",   "DIABP",        1L,        1L,
    "TEST01",  "PAT02",   "DIABP",        2L,        1L,
    "TEST01",  "PAT02",   "DIABP",        2L,        2L
  )

  expected_output <- tibble::tribble(
    ~STUDYID, ~USUBJID, ~VSTESTCD, ~VISITNUM, ~VSTPTNUM, ~ASEQ,
    "TEST01",  "PAT01",   "DIABP",        1L,        1L,    1L,
    "TEST01",  "PAT01",   "PULSE",        1L,        1L,    1L,
    "TEST01",  "PAT01",   "PULSE",        1L,        2L,    2L,
    "TEST01",  "PAT01",   "PULSE",        2L,        1L,    3L,
    "TEST01",  "PAT01",   "PULSE",        2L,        2L,    4L,
    "TEST01",  "PAT01",   "SYSBP",        1L,        1L,    1L,
    "TEST01",  "PAT01",   "SYSBP",        1L,        2L,    2L,
    "TEST01",  "PAT01",   "SYSBP",        2L,        1L,    3L,
    "TEST01",  "PAT02",   "DIABP",        1L,        1L,    1L,
    "TEST01",  "PAT02",   "DIABP",        2L,        1L,    2L,
    "TEST01",  "PAT02",   "DIABP",        2L,        2L,    3L
  )
...
test_that("derive_var_obs_number Test 2: sorting missing value  is smallest", {
  ...
  expected_output <- tibble::tribble(
    ~STUDYID, ~USUBJID, ~VSTESTCD, ~VISITNUM, ~VSTPTNUM, ~ASEQ,
    "TEST01",  "PAT01",   "DIABP",        1L,        NA,    1L,
    "TEST01",  "PAT01",   "DIABP",        1L,        1L,    2L,
    "TEST01",  "PAT01",   "PULSE",        1L,        1L,    1L,
    "TEST01",  "PAT01",   "PULSE",        1L,        2L,    2L,
    "TEST01",  "PAT01",   "PULSE",        2L,        1L,    3L,
    "TEST01",  "PAT01",   "PULSE",        2L,        2L,    4L,
...
test_that("derive_var_obs_number Test 4: expected condition for `check_type` ", {
  input <- tibble::tribble(
    ...
    "TEST01",  "PAT01",   "DIABP",        1L,        1L,
    "TEST01",  "PAT01",   "DIABP",        1L,        1L,
    "TEST01",  "PAT01",   "DIABP",        2L,        1L,
    "TEST01",  "PAT01",   "DIABP",        2L,        2L
  )
