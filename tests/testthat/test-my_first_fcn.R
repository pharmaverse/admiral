...
test_that("my_first_fcn Test 2: `exclamation=TRUE` returns 'Welcome to the admiral family!'", {
  expect_message(
...
test_that("my_first_fcn Test 3: `exclamation=FALSE` returns 'Welcome to the admiral family!'", {
  expect_message(
