...
test_that("derive_var_atoxgr_dir: Test 15 NCICTCAEv4 Hemoglobin increased", {
  exp_out_ctcv4_15 <- tibble::tribble(
    ...
    "Hemoglobin increased", 106,    65,     60,     "g/L",  "3",
    "Hemoglobin increased", 105,    65,     60,     "g/L",  "2",
    "Hemoglobin increased", 86,     65,     60,     "g/L",  "2",
    "Hemoglobin increased", 85,     65,     60,     "g/L",  "1",
    "Hemoglobin increased", 66,     65,     60,     "g/L",  "1",
    "Hemoglobin increased", 65,     65,     60,     "g/L",  "0",
    "Hemoglobin increased", NA,     65,     60,     "g/L",  NA,
    # BASE less than or equal to ANRHI
    "Hemoglobin increased", 106,    60,     65,     "g/L",  "3",
    "Hemoglobin increased", 105,    60,     65,     "g/L",  "2",
    "Hemoglobin increased", 86,     60,     65,     "g/L",  "2",
    "Hemoglobin increased", 85,     60,     65,     "g/L",  "1",
    "Hemoglobin increased", 66,     60,     65,     "g/L",  "1",
    "Hemoglobin increased", 65,     60,     65,     "g/L",  "0",
    "Hemoglobin increased", NA,     60,     65,     "g/L",  NA,
    # BASE missing
    "Hemoglobin increased", 106,    NA,     65,     "g/L",  "3",
    "Hemoglobin increased", 105,    NA,     65,     "g/L",  "2",
    "Hemoglobin increased", 86,     NA,     65,     "g/L",  "2",
    "Hemoglobin increased", 85,     NA,     65,     "g/L",  "1",
    "Hemoglobin increased", 66,     NA,     65,     "g/L",  "1",
    "Hemoglobin increased", 65,     NA,     65,     "g/L",  "0",
    "Hemoglobin increased", NA,     NA,     65,     "g/L",  NA,
    # Unit missing cannot grade
    "Hemoglobin increased", 200,    60,     65,     NA,     NA,
    # ANRHI missing - cannot grade
    "Hemoglobin increased", 200,    60,     NA,     "g/L",  NA,
    # AVAL missing cannot grade
    "Hemoglobin increased", NA,     60,     65,     "g/L",  NA,
  )
...
test_that("derive_var_atoxgr_dir: Test 18 NCICTCAEv4 Lymphocyte count decreased", {
  exp_out_ctcv4_18 <- tibble::tribble(
    ...
    # ANRLO not missing
    "Lymphocyte count decreased", 0.19,   140,    NA,     "10^9/L",  "4",
    "Lymphocyte count decreased", 0.2,    140,    NA,     "10^9/L",  "3",
    "Lymphocyte count decreased", 0.49,   140,    NA,     "10^9/L",  "3",
    "Lymphocyte count decreased", 0.5,    140,    NA,     "10^9/L",  "2",
    "Lymphocyte count decreased", 0.79,   140,    NA,     "10^9/L",  "2",
    "Lymphocyte count decreased", 0.8,    140,    NA,     "10^9/L",  "1",
    "Lymphocyte count decreased", 1.09,   1.1,    NA,     "10^9/L",  "1",
    "Lymphocyte count decreased", 1.1,    1.1,    NA,     "10^9/L",  "0",
    # ANRLO missing - can grade 2-4
    "Lymphocyte count decreased", 0.19,   NA,     NA,     "10^9/L",  "4",
    "Lymphocyte count decreased", 0.2,    NA,     NA,     "10^9/L",  "3",
    "Lymphocyte count decreased", 0.49,   NA,     NA,     "10^9/L",  "3",
    "Lymphocyte count decreased", 0.5,    NA,     NA,     "10^9/L",  "2",
    "Lymphocyte count decreased", 0.79,   NA,     NA,     "10^9/L",  "2",
    # ANRLO missing - can NOT grade 0 or 1
    "Lymphocyte count decreased", 0.8,    NA,     NA,     "10^9/L",  NA,
    "Lymphocyte count decreased", 1.09,   NA,     NA,     "10^9/L",  NA,
    "Lymphocyte count decreased", 1.1,    NA,     NA,     "10^9/L",  NA,
    # Unit missing cannot grade
    "Lymphocyte count decreased", 1.1,    1.1,    NA,     NA,        NA,
    # AVAL missing cannot grade
    "Lymphocyte count decreased", 1.1,    1.1,    NA,     "10^9/L",  "0",
  )
...
test_that("derive_var_atoxgr_dir: Test 24 NCICTCAEv4 Hypercalcemia", {
  exp_out_ctcv4_24 <- tibble::tribble(
    ~ATOXDSCH,       ~AVAL,  ~ANRLO, ~ANRHI, ~AVALU,    ~ATOXGRH,
    "Not a term",    3.5,    0,      2.5,    "mmol/L",  NA,
    NA_character_,   3.5,    0,      2.5,    "mmol/L",  NA,
    # ANRHI not missing
    "Hypercalcemia", 3.5,    0,      2.5,    "mmol/L",  "4",
    "Hypercalcemia", 3.4,    0,      2.5,    "mmol/L",  "3",
    "Hypercalcemia", 3.2,    0,      2.5,    "mmol/L",  "3",
    "Hypercalcemia", 3.1,    0,      2.5,    "mmol/L",  "2",
    "Hypercalcemia", 3,      0,      2.5,    "mmol/L",  "2",
    "Hypercalcemia", 2.9,    0,      2.5,    "mmol/L",  "1",
    "Hypercalcemia", 2.6,    0,      2.5,    "mmol/L",  "1",
    "Hypercalcemia", 2.5,    0,      2.5,    "mmol/L",  "0",
    # ANRHI missing - can grade 2-4
    "Hypercalcemia", 3.5,    0,      NA,     "mmol/L",  "4",
    "Hypercalcemia", 3.4,    0,      NA,     "mmol/L",  "3",
    "Hypercalcemia", 3.2,    0,      NA,     "mmol/L",  "3",
    "Hypercalcemia", 3.1,    0,      NA,     "mmol/L",  "2",
    "Hypercalcemia", 3,      0,      NA,     "mmol/L",  "2",
    # ANRHI missing - can NOT grade 0 or 1
    "Hypercalcemia", 2.9,    0,      NA,     "mmol/L",  NA,
    "Hypercalcemia", 2.6,    0,      NA,     "mmol/L",  NA,
    "Hypercalcemia", 2.5,    0,      NA,     "mmol/L",  NA,
    # Unit missing cannot grade
    "Hypercalcemia", 2.5,    0,      2.5,    NA,        NA,
    # AVAL missing cannot grade
    "Hypercalcemia", NA,     0,      2.5,    "mmol/L",  NA,
  )
...
test_that("derive_var_atoxgr_dir: Test 25 NCICTCAEv4 Hypercalcemia (Ionized)", {
  exp_out_ctcv4_25 <- tibble::tribble(
    ~ATOXDSCH,                 ~AVAL,  ~ANRLO, ~ANRHI, ~AVALU,    ~ATOXGRH,
    "Not a term",              1.9,    0,      1.3,    "mmol/L",  NA,
    NA_character_,             1.9,    0,      1.3,    "mmol/L",  NA,
    # ANRHI not missing
    "Hypercalcemia (Ionized)", 1.9,    0,      1.3,    "mmol/L",  "4",
    "Hypercalcemia (Ionized)", 1.8,    0,      1.3,    "mmol/L",  "3",
    "Hypercalcemia (Ionized)", 1.7,    0,      1.3,    "mmol/L",  "3",
    "Hypercalcemia (Ionized)", 1.6,    0,      1.3,    "mmol/L",  "2",
    "Hypercalcemia (Ionized)", 1.51,   0,      1.3,    "mmol/L",  "2",
    "Hypercalcemia (Ionized)", 1.5,    0,      1.3,    "mmol/L",  "1",
    "Hypercalcemia (Ionized)", 1.4,    0,      1.3,    "mmol/L",  "1",
    "Hypercalcemia (Ionized)", 1.3,    0,      1.3,    "mmol/L",  "0",
    # ANRHI missing - can grade 2-4
    "Hypercalcemia (Ionized)", 1.9,    0,      NA,     "mmol/L",  "4",
    "Hypercalcemia (Ionized)", 1.8,    0,      NA,     "mmol/L",  "3",
    "Hypercalcemia (Ionized)", 1.7,    0,      NA,     "mmol/L",  "3",
    "Hypercalcemia (Ionized)", 1.6,    0,      NA,     "mmol/L",  "2",
    "Hypercalcemia (Ionized)", 1.51,   0,      NA,     "mmol/L",  "2",
    # ANRHI missing - can NOT grade 0 or 1
    "Hypercalcemia (Ionized)", 1.5,    0,      NA,     "mmol/L",  NA,
    "Hypercalcemia (Ionized)", 1.4,    0,      NA,     "mmol/L",  NA,
    "Hypercalcemia (Ionized)", 1.3,    0,      NA,     "mmol/L",  NA,
    # Unit missing cannot grade
    "Hypercalcemia (Ionized)", 1.3,    0,      1.3,    NA,        NA,
    # AVAL missing cannot grade
    "Hypercalcemia (Ionized)", NA,     0,      1.3,    "mmol/L",  NA,
  )
...
test_that("derive_var_atoxgr_dir: Test 26 NCICTCAEv4 Hyperglycemia (Fasting)", {
  exp_out_ctcv4_26 <- tibble::tribble(
    ~ATOXDSCH,                 ~AVAL,  ~ANRLO, ~ANRHI, ~AVALU,    ~ATOXGRH,
    "Not a term",              27.9,   0,      5.3,    "mmol/L",  NA,
    NA_character_,             27.9,   0,      5.3,    "mmol/L",  NA,
    # ANRHI not missing
    "Hyperglycemia (Fasting)", 27.9,   0,      5.3,    "mmol/L",  "4",
    "Hyperglycemia (Fasting)", 27.8,   0,      5.3,    "mmol/L",  "3",
    "Hyperglycemia (Fasting)", 14,     0,      5.3,    "mmol/L",  "3",
    "Hyperglycemia (Fasting)", 13.9,   0,      5.3,    "mmol/L",  "2",
    "Hyperglycemia (Fasting)", 9,      0,      5.3,    "mmol/L",  "2",
    "Hyperglycemia (Fasting)", 8.9,    0,      5.3,    "mmol/L",  "1",
    "Hyperglycemia (Fasting)", 5.4,    0,      5.3,    "mmol/L",  "1",
    "Hyperglycemia (Fasting)", 5.3,    0,      5.3,    "mmol/L",  "0",
    # ANRHI missing - can grade 2-4
    "Hyperglycemia (Fasting)", 27.9,   0,      NA,     "mmol/L",  "4",
    "Hyperglycemia (Fasting)", 27.8,   0,      NA,     "mmol/L",  "3",
    "Hyperglycemia (Fasting)", 14,     0,      NA,     "mmol/L",  "3",
    "Hyperglycemia (Fasting)", 13.9,   0,      NA,     "mmol/L",  "2",
    "Hyperglycemia (Fasting)", 9,      0,      NA,     "mmol/L",  "2",
    # ANRHI missing - can NOT grade 0 or 1
    "Hyperglycemia (Fasting)", 8.9,    0,      NA,     "mmol/L",  NA,
    "Hyperglycemia (Fasting)", 5.4,    0,      NA,     "mmol/L",  NA,
    "Hyperglycemia (Fasting)", 5.3,    0,      NA,     "mmol/L",  NA,
    # Unit missing cannot grade
    "Hyperglycemia (Fasting)", 5.3,    0,      5.3,    NA,        NA,
    # AVAL missing cannot grade
    "Hyperglycemia (Fasting)", NA,     0,      5.3,    "mmol/L",  NA,
  )
...
test_that("derive_var_atoxgr_dir: Test 26 NCICTCAEv4 Hyperglycemia", {
  exp_out_ctcv4_27 <- tibble::tribble(
    ~ATOXDSCH,       ~AVAL,  ~ANRLO, ~ANRHI, ~AVALU,    ~ATOXGRH,
    "Not a term",    27.9,   0,      5.3,    "mmol/L",  NA,
    NA_character_,   27.9,   0,      5.3,    "mmol/L",  NA,
    "Hyperglycemia", 27.9,   0,      5.3,    "mmol/L",  "4",
    "Hyperglycemia", 27.8,   0,      5.3,    "mmol/L",  "3",
    "Hyperglycemia", 14,     0,      5.3,    "mmol/L",  "3",
    "Hyperglycemia", 13.9,   0,      5.3,    "mmol/L",  "0",
    "Hyperglycemia", 5.3,    0,      NA,     "mmol/L",  "0",
    # Unit missing cannot grade
    "Hyperglycemia", 5.3,    0,      5.3,    NA,        NA,
    # AVAL missing cannot grade
    "Hyperglycemia", NA,     0,      5.3,    "mmol/L",  NA,
  )
...
test_that("derive_var_atoxgr_dir: Test 28 NCICTCAEv4 Hyperkalemia", {
  exp_out_ctcv4_28 <- tibble::tribble(
    ~ATOXDSCH,       ~AVAL,  ~ANRLO, ~ANRHI, ~AVALU,    ~ATOXGRH,
    "Not a term",    7.1,    0,      5.1,    "mmol/L",  NA,
    NA_character_,   7.1,    0,      5.1,    "mmol/L",  NA,
    # ANRHI not missing
    "Hyperkalemia",  7.1,    0,      5.1,    "mmol/L",  "4",
    "Hyperkalemia",  7,      0,      5.1,    "mmol/L",  "3",
    "Hyperkalemia",  6.1,    0,      5.1,    "mmol/L",  "3",
    "Hyperkalemia",  6,      0,      5.1,    "mmol/L",  "2",
    "Hyperkalemia",  5.6,    0,      5.1,    "mmol/L",  "2",
    "Hyperkalemia",  5.5,    0,      5.1,    "mmol/L",  "1",
    "Hyperkalemia",  5.2,    0,      5.1,    "mmol/L",  "1",
    "Hyperkalemia",  5.1,    0,      5.1,    "mmol/L",  "0",
    # ANRHI missing - can grade 2-4
    "Hyperkalemia",  7.1,    0,      NA,     "mmol/L",  "4",
    "Hyperkalemia",  7,      0,      NA,     "mmol/L",  "3",
    "Hyperkalemia",  6.1,    0,      NA,     "mmol/L",  "3",
    "Hyperkalemia",  6,      0,      NA,     "mmol/L",  "2",
    "Hyperkalemia",  5.6,    0,      NA,     "mmol/L",  "2",
    # ANRHI missing - can NOT grade 0 or 1
    "Hyperkalemia",  5.5,    0,      NA,     "mmol/L",  NA,
    "Hyperkalemia",  5.2,    0,      NA,     "mmol/L",  NA,
    "Hyperkalemia",  5.1,    0,      NA,     "mmol/L",  NA,
    # Unit missing cannot grade
    "Hyperkalemia",  5.1,    0,      5.1,    NA,        NA,
    # AVAL missing cannot grade
    "Hyperkalemia",  NA,     0,      5.1,    "mmol/L",  NA,
  )
...
test_that("derive_var_atoxgr_dir: Test 30 NCICTCAEv4 Hypernatremia", {
  exp_out_ctcv4_30 <- tibble::tribble(
    ~ATOXDSCH,        ~AVAL,  ~ANRLO, ~ANRHI, ~AVALU,    ~ATOXGRH,
    "Not a term",     161,    0,      140,    "mmol/L",  NA,
    NA_character_,    161,    0,      140,    "mmol/L",  NA,
    # ANRHI not missing
    "Hypernatremia",  161,    0,      140,    "mmol/L",  "4",
    "Hypernatremia",  160,    0,      140,    "mmol/L",  "3",
    "Hypernatremia",  156,    0,      140,    "mmol/L",  "3",
    "Hypernatremia",  155,    0,      140,    "mmol/L",  "2",
    "Hypernatremia",  151,    0,      140,    "mmol/L",  "2",
    "Hypernatremia",  150,    0,      140,    "mmol/L",  "1",
    "Hypernatremia",  141,    0,      140,    "mmol/L",  "1",
    "Hypernatremia",  140,    0,      140,    "mmol/L",  "0",
    # ANRHI missing - can grade 3-4
    "Hypernatremia",  161,    0,      NA,     "mmol/L",  "4",
    "Hypernatremia",  160,    0,      NA,     "mmol/L",  "3",
    "Hypernatremia",  156,    0,      NA,     "mmol/L",  "3",
    "Hypernatremia",  155,    0,      NA,     "mmol/L",  "2",
    "Hypernatremia",  151,    0,      NA,     "mmol/L",  "2",
    # ANRHI missing - can NOT grade 0 or 1
    "Hypernatremia",  150,    0,      NA,     "mmol/L",  NA,
    "Hypernatremia",  141,    0,      NA,     "mmol/L",  NA,
    "Hypernatremia",  140,    0,      NA,     "mmol/L",  NA,
    # Unit missing cannot grade
    "Hypernatremia",  140,    0,      140,    NA,        NA,
    # AVAL missing cannot grade
    "Hypernatremia",  NA,     0,      140,    "mmol/L",  NA,
  )
