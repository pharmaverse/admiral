...
# assert_vars ----
## Test 31: no error if `arg` is not a list of unquoted variable names ----
test_that("assert_vars Test 31: no error if `arg` is not a list of unquoted variable names", {
  example_fun <- function(arg) {
    assert_vars(arg)
  }
...
# assert_named_exprs ----
## Test 52: error if `arg` is not a named list of expressions (deprecation error) ----
test_that("assert_named_exprs Test 52: error if `arg` is not a named list of expressions (deprecation error)", { # nolint
  example_fun <- function(arg) {
...
## Test 53: no error if `arg` is NULL and optional is TRUE (deprecation error) ----
test_that("assert_named_exprs Test 53: no error if `arg` is NULL and optional is TRUE (deprecation error)", { # nolint
  example_fun <- function(arg) {
...
## Test 54: no error if `arg` is a named list of expressions (deprecation error) ----
test_that("assert_named_exprs Test 54: no error if `arg` is a named list of expressions (deprecation error)", { # nolint
  example_fun <- function(arg) {
    assert_named_exprs(arg)
  }
...
## Test 60: no error if `arg` is a parameter of a function (deprecation error) ----
test_that("assert_function_param Test 60: no error if `arg` is a parameter of a function (deprecation error)", { # nolint
  hello <- function(name) {
...
## Test 61: error if expected function parameters are missing (deprecation error) ----
test_that("assert_function_param Test 61: error if expected function parameters are missing (deprecation error)", { # nolint
  hello <- function(name) {
    print(sprintf("Hello %s", name))
  }
...
# assert_unit ----
## Test 62: no error if the parameter is provided in the expected unit ----
test_that("assert_unit Test 62: no error if the parameter is provided in the expected unit", {
  advs <- tibble::tribble(
...
## Test 63: error if there are multiple units in the input dataset ----
test_that("assert_unit Test 63: error if there are multiple units in the input dataset", {
  advs <- tibble::tribble(
    ~USUBJID, ~VSTESTCD, ~VSTRESN, ~VSSTRESU, ~PARAMCD, ~AVAL,
    "P01",    "WEIGHT",      80.1, "kg",      "WEIGHT",  80.1,
...
## Test 64: error if unexpected unit in the input dataset ----
test_that("assert_unit Test 64: error if unexpected unit in the input dataset", {
  advs <- tibble::tribble(
    ~USUBJID, ~VSTESTCD, ~VSTRESN, ~VSSTRESU, ~PARAMCD, ~AVAL,
    "P01",    "WEIGHT",      80.1, "kg",      "WEIGHT",  80.1,
    "P02",    "WEIGHT",      85.7, "kg",      "WEIGHT",  85.7
