...
test_that("derive_var_age_years - Warning is issued if age_unit is not null, but
...
test_that("derive_var_age_years - Error is issued if age_unit consists of more
