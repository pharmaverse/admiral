...
# derive_vars_merged Test 2: error when relatioship is incorrectly specificed 'one-to-one'
...
# derive_vars_merged Test 2: merge selected variables with relatioship as 'one-to-one'
