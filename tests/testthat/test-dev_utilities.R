...
# convert_dtm_to_dtc ----
## Test 2: `convert_dtm_to_dtc` is in correct format ----
test_that("convert_dtm_to_dtc Test 2: `convert_dtm_to_dtc` is in correct format", {
  expect_equal(
...
## Test 3: `convert_dtm_to_dtc` Error is thrown if dtm is not in correct format ----
test_that("convert_dtm_to_dtc Test 3: `convert_dtm_to_dtc` Error is thrown if dtm is not in correct format", {
  expect_error(
