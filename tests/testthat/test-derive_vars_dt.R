...
test_that("default: no date imputation, time part set o 00:00:00, add DTF", {
  expected_output <- tibble::tribble(
    ...
    "2019-07-18T15:25:40", as.Date("2019-07-18"), as.character(NA),
    "2019-07-18", as.Date("2019-07-18"), as.character(NA),
    "2019-02", as.Date(NA), as.character(NA),
    "2019", as.Date(NA), as.character(NA),
    "2019---07", as.Date(NA), as.character(NA)
  )
