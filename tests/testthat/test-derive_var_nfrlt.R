...
## Test 3: custom infusion duration ----
test_that("derive_var_nfrlt Test 3: custom infusion duration", {
  input <- tibble::tribble(
    ~USUBJID, ~VISITDY, ~PCTPT,
    "001",    1,        "Pre-dose",
    "001",    1,        "EOI",
...
## Test 12: error if infusion_duration not positive ----
test_that("derive_var_nfrlt Test 12: error if infusion_duration not positive", {
  input <- tibble::tribble(
    ~USUBJID, ~VISITDY, ~PCTPT,
    "001",    1,        "EOI"
  )
