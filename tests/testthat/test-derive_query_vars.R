...
test_that("Derive CQ and SMQ variables with two term levels", {
  queries <- tibble::tribble(
    ...
    "SMQ05", "Immune-Mediated Pneumonitis", NA_character_, "NARROW", "AEDECOD", "ALVEOLAR PROTEINOSIS",
  ...
  expected_output <- tibble::tribble(
    ~USUBJID, ~ASTDTM, ~AETERM, ~AESEQ, ~AEDECOD, ~AELLT, ~CQ01NAM, ~SMQ03NAM, ~SMQ03CD, ~SMQ03SC, ~CQ06NAM, ~SMQ05NAM, ~SMQ05SC,
    "01", "2020-06-02 23:59:59", "ALANINE AMINOTRANSFERASE ABNORMAL", 3, "Alanine aminotransferase abnormal", NA_character_, "Immune-Mediated Hepatitis (Diagnosis and Lab Abnormalities)", NA_character_, NA_character_, NA_character_, NA_character_, NA_character_, NA_character_,
    "02", "2020-06-05 23:59:59", "BASEDOW'S DISEASE", 5, "Basedow's disease", NA_character_, NA_character_, "Immune-Mediated Hypothyroidism", "20000161", "NARROW", NA_character_, NA_character_, NA_character_,
    "03", "2020-06-07 23:59:59", "SOME TERM", 2, "Some query", "Some term",  NA_character_, NA_character_, NA_character_, NA_character_, "Some query", NA_character_, NA_character_,
