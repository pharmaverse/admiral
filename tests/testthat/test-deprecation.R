...
## Test 17: A warning is issued if `derive_param_extreme_event()` is called with
## `date_var` parameter included ----
test_that("deprecation Test 17: A warning is issued if `derive_param_first_event()` is called with `date_var` parameter included",
          {
            rlang::with_options(lifecycle_verbosity = "warning", {
