...
vignette](https:/pharmaverse.github.io/admiral/test_web/articles/visits_periods.html#periods_adsl)
...
vignette](https:/pharmaverse.github.io/admiral/test_web/articles/visits_periods.html#treatment_adsl).
...
See also [Generic
Functions](https:/pharmaverse.github.io/admiral/test_web/articles/generic.md).
...
|--------------------------------------------------------------------------------------|---------------------------|
| [`ADSL`](https:/pharmaverse.github.io/admiral/test_web/articles/templates.html#adsl) | `use_ad_template("ADSL")` |
