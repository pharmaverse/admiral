...
Imputation](https:/pharmaverse.github.io/admiral/test_web/articles/imputation.Rmd)
...
|--------------------------------------------------------------------------------------|---------------------------|
| [`ADEX`](https:/pharmaverse.github.io/admiral/test_web/articles/templates.html#adex) | `use_ad_template("ADEX")` |
