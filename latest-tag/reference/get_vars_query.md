...
[`vignette("occds")`](https:/pharmaverse.github.io/admiral/v1.4.2/articles/occds.md).

A query dataset is expected as an input to this function. See the
[`vignette("queries_dataset")`](https:/pharmaverse.github.io/admiral/v1.4.2/articles/queries_dataset.md)
