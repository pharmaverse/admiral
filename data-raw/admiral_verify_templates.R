...
#' This package loads saved RDA files (generated from `get_dataset_old`) and uses diffdf to compare the loaded data with a new dataset generated by `get_dataset_new` or a base for comparison.
#'
#' Usage
#'
