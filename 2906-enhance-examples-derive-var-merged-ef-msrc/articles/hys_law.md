...
|----------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------|
| [`ADLBHY`](https:/pharmaverse.github.io/admiral/cran-release/2906-enhance-examples-derive-var-merged-ef-msrc/articles/templates.html#adlbhy) | `use_ad_template("ADLBHY")` |
