...
|------------------------------------------------------------------------------------------------------------------------------------------|---------------------------|
| [`ADAB`](https:/pharmaverse.github.io/admiral/cran-release/2906-enhance-examples-derive-var-merged-ef-msrc/articles/templates.html#adab) | `use_ad_template("ADAB")` |
