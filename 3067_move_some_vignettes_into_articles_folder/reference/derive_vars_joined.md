...
### Note on usage versus [`derive_vars_merged()`](https:/pharmaverse.github.io/admiral/3067_move_some_vignettes_into_articles_folder/reference/derive_vars_merged.md)
