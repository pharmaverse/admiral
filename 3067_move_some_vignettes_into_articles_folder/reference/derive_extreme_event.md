...
### Add a new record for the worst observation using [`event()`](https:/pharmaverse.github.io/admiral/3067_move_some_vignettes_into_articles_folder/reference/event.md) objects
...
### Events based on comparison across records ([`event_joined()`](https:/pharmaverse.github.io/admiral/3067_move_some_vignettes_into_articles_folder/reference/event_joined.md))
...
### Specifying different arguments across [`event()`](https:/pharmaverse.github.io/admiral/3067_move_some_vignettes_into_articles_folder/reference/event.md) objects
