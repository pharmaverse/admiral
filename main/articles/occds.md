...
|----------------------------------------------------------------------------------|---------------------------|
| [`ADAE`](https:/pharmaverse.github.io/admiral/main/articles/templates.html#adae) | `use_ad_template("ADAE")` |
| [`ADCM`](https:/pharmaverse.github.io/admiral/main/articles/templates.html#adcm) | `use_ad_template("ADCM")` |
