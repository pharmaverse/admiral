...
|-------------------------------------------------------------------------------------------------|----------------------------|
| [`ADPC`](https:/pharmaverse.github.io/admiral/cran-release/main/articles/templates.html#adpc)   | `use_ad_template("ADPC")`  |
| [`ADPPK`](https:/pharmaverse.github.io/admiral/cran-release/main/articles/templates.html#adppk) | `use_ad_template("ADPPK")` |
