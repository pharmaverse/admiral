...
Imputation](https:/pharmaverse.github.io/admiral/cran-release/main/articles/imputation.Rmd)
...
|-----------------------------------------------------------------------------------------------|---------------------------|
| [`ADEX`](https:/pharmaverse.github.io/admiral/cran-release/main/articles/templates.html#adex) | `use_ad_template("ADEX")` |
